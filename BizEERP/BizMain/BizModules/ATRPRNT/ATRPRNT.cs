...
namespace ASOMS.TR
{
    public partial class TRfilter : Form
    {
        ...
        protected ASOMS.BizModules.Tools.CRForm crpt1 = null;
        protected int selectReportID;
        protected string ReportLocation;

        public TRfilter(DBAccess dbAcc, string[,,] Array)
        {
            InitializeComponent();
            this.dbAccess = dbAcc;
            this.arr2 = Array;
        ...
        private void btn_Preview_Click(object sender, EventArgs e)
        {
            ...
            {
                this.crpt1 = new ASOMS.BizModules.Tools.CRForm();
