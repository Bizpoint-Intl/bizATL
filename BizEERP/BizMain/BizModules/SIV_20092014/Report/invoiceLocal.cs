...
namespace ATL.BizModules.SIV_20092014.Report {
    ...
    public class invoiceLocal : ReportClass {
    ...
    public class CachedinvoiceLocal : Component, ICachedReport {
        
        public CachedinvoiceLocal() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            invoiceLocal rpt = new invoiceLocal();
            rpt.Site = this.Site;
            return rpt;
        }
