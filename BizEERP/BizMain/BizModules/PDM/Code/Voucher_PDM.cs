...
namespace ATL.PDM
{
    public class Voucher_PDM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_PDM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_PDM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
