...
namespace ATL.REGEXM
{
    public class Voucher_REGEXM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_REGEXM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_REGEXM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
