...
namespace ATL.MultiColumnComboBox
{
	/// <summary>
	...
	public class ColumnComboBox : ComboBox
	{
        ...
        protected override void OnSelectionChangeCommitted(EventArgs e)
        {
            ...
            {
                throw new Exception(ex.Message + "\r\nIn ColumnComboBox.OnSelectionChangeCommitted(EventArgs).");
            }
        }
				...
				foreach(DataRowView drv in m_dvView)
				{
					for(int index = 0; index < m_Cols.Count; index++)
					{
                        ...
                        if (iTempWidth > m_iaColWidths[index])
                            m_iaColWidths[index] = WidthTest[index];
        ...
        public void ColWidthNew(int[] intWidth)
        {
            WidthTest = intWidth;
        }
