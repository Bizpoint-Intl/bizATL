...
namespace ATL.Network
{
    ...
    public class NetworkDrive
    {
        ...
        public static string MapNetworkDrive(string sNetworkPath)
        {
            ...
            try
            {
                sDriveLetter = System.Configuration.ConfigurationManager.AppSettings.Get("NetworkDrive").ToString();
                ...
                string uName = System.Configuration.ConfigurationManager.AppSettings.Get("ServerUserName").ToString();
                string pWord = System.Configuration.ConfigurationManager.AppSettings.Get("ServerPassWord").ToString();
                //WNetAddConnection2(ref oNetworkResource, pWord, @"TESTSVR\" + uName, 1);
        ...
        public static int DisconnectNetworkDrive(bool bForceDisconnect)
        {
            string sDriveLetter = System.Configuration.ConfigurationManager.AppSettings.Get("NetworkDrive").ToString();
            if (bForceDisconnect)
            {
