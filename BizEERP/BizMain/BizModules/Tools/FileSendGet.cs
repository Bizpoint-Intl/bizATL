...
namespace ATL.BizModules.FileAcc
{
    class FileSendGet
    {
        ...
        private void FileUpload()
        {
            ...
            if (File.OpenRead(tmpLocation.ToString()).Length >= 0)
            {
                try
                {
                    string sZipFileName = EmpNo + "-" + BizLogicTools.Tools.getGUID() + "-" + Type;
                    ...
                    System.IO.DirectoryInfo fl = new DirectoryInfo(SaveLoc + @"\\" + EmpNo + "\\" + Type + "\\");                   
                    ...
                    //{
                    //    sZipFileName = FileNameGenerator(sZipFileName.Trim());
                    //}

                    while (File.Exists(fl.FullName + "\\" + sZipFileName.Trim() + ".zip"))
                    {
                        sZipFileName = sZipFileName = EmpNo + "-" + BizLogicTools.Tools.getGUID() + "-" + Type;
                    }
