...
namespace ATL.HRAM
{
    public class Voucher_HRAM: BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_HRAM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_HRAM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
