...
namespace ATL.PRM
{
    public class Voucher_PRM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_PRM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_PRM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
