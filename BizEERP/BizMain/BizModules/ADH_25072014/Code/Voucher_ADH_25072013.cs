...
namespace ASOMS.ADH
{
    public class Voucher_ADH : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        protected DataGrid dgAdh4 = null;       
        ...
        private void Initialise()
        {
            ...
            dgAdh4 = BizXmlReader.CurrentInstance.GetControl(feedbackFormName, "dg_feedback") as DataGrid;
            dgAdh4.MouseDoubleClick +=new MouseEventHandler(dgtxt_MouseDoubleClick);
        ...
        private void adh4_btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                InsertAdh4["dateraised"] = Convert.ToDateTime(txt_Daterasied.Text);
                InsertAdh4["Raisedby"] = txt_Raisedby.Text;
                InsertAdh4["desc"] = txt_desc.Text;
                InsertAdh4["followup"] = txt_followup.Text;
        ...
        private void dgtxt_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                {// if user double click Row Header or Cell, the selected row will be added to CRQ2.
                    ...
                    DataRow drCur = getcurrentrow(dgAdh4);

                    string GetAdh4Row = "Select * from adh4 where [guid]='" + drCur["guid"].ToString() + "'";

                    DataTable tempAdh4 = BizFunctions.ExecuteQuery(this.dbaccess.DataSet, GetAdh4Row);

                    if (tempAdh4 != null)
                    {
                        if (tempAdh4.Rows.Count > 0)
                        {
                            DataRow dr1 = tempAdh4.Rows[0];
