...
namespace ATL.BizModules.SDB.Report {
    ...
    public class debitNote2 : ReportClass {
    ...
    public class CacheddebitNote2 : Component, ICachedReport {
        
        public CacheddebitNote2() {
        }
