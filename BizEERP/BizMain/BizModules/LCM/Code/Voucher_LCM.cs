...
namespace ATL.LCM
{
    public class Voucher_LCM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_LCM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_LCM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
