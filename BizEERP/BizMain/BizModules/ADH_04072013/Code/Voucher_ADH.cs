...
using ASOMS.BizModules.FileAcc2;
using ASOMS.Network;
...
namespace ASOMS.ADH
{
    public class Voucher_ADH : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_ADH(string moduleName, Hashtable voucherBaseHelpers) : base("VoucherGridInfo_ADH.xml", moduleName, voucherBaseHelpers)
        {
        ...
        private void btn_Voucher_Reports_Click(object sender, EventArgs e)
        {
            ...
            if (adh["status"].ToString().Trim() == Common.DEFAULT_DOCUMENT_STATUSO)
            {
                if (BizValidate.CheckRowState(dbaccess.DataSet, "adh/adh1/adh3"))
                {
                    ...
                    ReportLists.Reports ReportForm = new ASOMS.ReportLists.Reports(false, "ADH", "ADH", adh["refnum"].ToString());
        ...
        //    if (BizFunctions.IsEmpty(ADH["subtotal"]))
        //    {
        //        ADH["subtotal"] = 0;
        //    }
        //    //if (BizFunctions.IsEmpty(ADH["additionalcosts"]))
        //    //{
        //    //    ADH["additionalcosts"] = 0;
        //    //}
        //    if (BizFunctions.IsEmpty(ADH["discamt"]))
        //    {
        //        ADH["discamt"] = 0;
        //    }
        //    //if (BizFunctions.IsEmpty(ADH["equipmentcosts"]))
        //    //{
        //    //    ADH["equipmentcosts"] = 0;
        //    //}

        //    //ADH["ttlbillingamt"] = (Convert.ToDecimal(ADH["subtotal"]) + Convert.ToDecimal(ADH["additionalcosts"]) + Convert.ToDecimal(ADH["equipmentcosts"])) - Convert.ToDecimal(ADH["discamt"]);
        //    ADH["ttlbillingamt"] = Convert.ToDecimal(ADH["subtotal"]) - Convert.ToDecimal(ADH["discamt"]);
        ...
        private void Refresh_Header()
        {
            ...
            adh["totalmonths"] = ASOMS.TimeUtilites.TimeTools.MonthDiff(Convert.ToDateTime(adh["commencedate"]), Convert.ToDateTime(adh["enddate"]));
            RefreshMonthNo();
            headerFlag = false;
        }
        ...
        protected void adh10_btnBrowseEdu_Click(object sender, System.EventArgs e)
        {
            try
            {
                ASOMS.BizModules.StaCompressFolders.StaCompress form = new ASOMS.BizModules.StaCompressFolders.StaCompress(dbaccess, "ADH", "ADH10", "refnum");
                form.ShowDialog();
                form.Close();
        ...
        protected void adh10_btnDownloadEdu_Click(object sender, System.EventArgs e)
        {
            try
            {
                ASOMS.BizModules.StaCompressFolders.StaDecommpress form = new ASOMS.BizModules.StaCompressFolders.StaDecommpress(dbaccess, "ADH", "ADH10", "refnum");
                form.ShowDialog();
                form.Close();
            }
            catch (Exception ex)
        ...
        private void getBgtEstTotal()
        {
            ...
            txt_grossProfit1.Text = Convert.ToString(Convert.ToDecimal(adh["bgtestctr"]) - grandTotal);
        ...
        private void getBgtManualActTotal()
        {
            ...
            txt_grossProfit2.Text = Convert.ToString(Convert.ToDecimal(adh["bgtActMctr"]) - grandTotal);
        ...
        private void getBgtSysActTotal()
        {
            ...
            txt_grossProfit3.Text = Convert.ToString(Convert.ToDecimal(adh["bgtsactctr"]) - grandTotal);
        ...
        private void getBgtActualTotal()
        {
            ...
            txt_grossProfit4.Text = Convert.ToString(Convert.ToDecimal(adh["bgtactctr"]) - grandTotal);
        ...
        private void getBgtLatestActTotal()
        {
            ...
            txt_grossProfit5.Text = Convert.ToString(Convert.ToDecimal(adh["bgtlactctr"]) - grandTotal);
