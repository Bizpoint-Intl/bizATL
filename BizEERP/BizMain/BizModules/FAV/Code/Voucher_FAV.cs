...
namespace ATL.FAV
{
    public class Voucher_FAV : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_FAV(string moduleName, Hashtable voucherBaseHelpers, string type)
            : base("VoucherGridInfo_FAV.xml", moduleName, voucherBaseHelpers)
        {
            this.Flag = type;
        }
        ...
        private void InitializeControls()
        {
            ...
            ckInvdate = BizXmlReader.CurrentInstance.GetControl(this.formdDetailName, "ck_invdate") as CheckBox;
