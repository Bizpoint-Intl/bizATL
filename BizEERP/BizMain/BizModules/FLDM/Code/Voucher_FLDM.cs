...
namespace ATL.FLDM
{
    public class Voucher_FLDM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_FLDM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_FLDM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
