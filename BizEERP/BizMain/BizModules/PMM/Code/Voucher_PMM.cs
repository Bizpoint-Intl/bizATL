...
namespace ATL.PMM
{
    public class Voucher_PMM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_PMM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_PMM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
