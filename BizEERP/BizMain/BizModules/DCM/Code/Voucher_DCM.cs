...
namespace ATL.DCM
{
    public class Voucher_DCM : BizRAD.BizApplication.VoucherBaseHelper
    {
        #region Class Variables
        protected string headerFormName = null;
        protected DBAccess dbaccess = null;
        protected Button Btn_RichText;
        #endregion

        #region Construct

        public Voucher_DCM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_DCM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
        ...
        {
            Btn_RichText = BizXmlReader.CurrentInstance.GetControl(headerFormName, "Btn_RichText") as Button;
            Btn_RichText.Click += new EventHandler(Btn_RichText_Click);

        }

        void Btn_RichText_Click(object sender, EventArgs e)
        {
            WordForm1 wf = new WordForm1(this.dbaccess, "DCM", "doc",null);
            wf.Show();
            wf.Focus();
        }
