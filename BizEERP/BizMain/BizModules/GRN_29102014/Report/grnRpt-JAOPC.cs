...
namespace ATL.BizModules.GRN_29102014.Report {
    using System;
    ...
    public class grnRpt_JAOPC : ReportClass {
    ...
    public class CachedgrnRpt_JAOPC : Component, ICachedReport {
        
        public CachedgrnRpt_JAOPC() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            grnRpt_JAOPC rpt = new grnRpt_JAOPC();
            rpt.Site = this.Site;
            return rpt;
        }
