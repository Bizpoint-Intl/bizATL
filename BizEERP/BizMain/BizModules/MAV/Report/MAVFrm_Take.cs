...
namespace ATL.BizModules.MAV.Report {
    ...
    public class MAVFrm_Take : ReportClass {
    ...
    public class CachedMAVFrm_Take : Component, ICachedReport {
        
        public CachedMAVFrm_Take() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            MAVFrm_Take rpt = new MAVFrm_Take();
            rpt.Site = this.Site;
            return rpt;
        }
