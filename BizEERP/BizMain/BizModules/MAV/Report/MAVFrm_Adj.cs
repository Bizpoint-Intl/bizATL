...
namespace ATL.BizModules.MAV.Report {
    ...
    public class MAVFrm_Adj : ReportClass {
    ...
    public class CachedMAVFrm_Adj : Component, ICachedReport {
        
        public CachedMAVFrm_Adj() {
        }
