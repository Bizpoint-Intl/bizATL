...
namespace ATL.DCTM
{
    public class Voucher_DCTM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_DCTM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_DCTM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
