...
namespace ATL.WOR
{
    public class Voucher_WOR : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        protected string headerFormName, NewTaskForm, OutstandingForm, LocationFormName = null;
        ...
        protected Button btnExtract1, columnButton, locColumnButton1 = null;
        protected DataGrid Datagrid1, Datagrid2, dg_outstanding, dg_newtask, dg_location = null;
        ...
        protected Button Btn_Show, btnLists = null;
        #endregion
        ...
        protected override void Document_Print_OnClick(object sender, DocumentPrintEventArgs e)
        {
            ...
            //        selectedCollection.Add("coy", "SELECT * FROM coy");
            //        selectedCollection.Add("pdm", "SELECT * FROM PDM");
            //        selectedCollection.Add("arm", "SELECT * FROM ARM");
            //        selectedCollection.Add("sitm", "SELECT * FROM SITM");
            ...
            //        DataTable dtAllPdTask = new DataTable("dtAllPdTask");
            //        dtAllPdTask = NewTaskTB.Copy();
            ...
            //        if (e.DBAccess.DataSet.Tables.Contains("dtAllPdTask"))
            //        {
            //            e.DBAccess.DataSet.Tables["dtAllPdTask"].Dispose();
            //        }
            //        else
            //        {
            //            e.DBAccess.DataSet.Tables.Add(dtAllPdTask);
            //        }
