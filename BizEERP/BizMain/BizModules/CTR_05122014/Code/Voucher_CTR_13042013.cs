    ...
    public class Voucher_CTR : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        protected TextBox ctr1_ttlamt, ctr3_ttlamt, txt_ttlamt, ctr5_ttlamt, ctr6_ttlamt, ctr7_ttlamt, ctr8_ttlamt, ctr9_ttlamt, ctrh_arnum, txt_grossProfit1, txt_grandTotal1,
                          txt_grossProfit2, txt_grandTotal2,txt_grossProfit3, txt_grandTotal3,txt_grossProfit4, txt_grandTotal4,txt_grossProfit5, txt_grandTotal5,
                           txt_Raisedby, txt_desc, txt_followup,
            txt_bgtsactctr,txt_bgtsactsal,txt_bgtsactmat,txt_bgtsactchem,txt_bgtsactmach,txt_bgtsactequip,txt_bgtsactToi,txt_bgtsactPrd,
            txt_bgtsactLand,txt_bgtsactSub,txt_bgtsactOther,txt_bgtactctr,txt_bgtactsal,txt_bgtactmat,txt_bgtactchem,txt_bgtactmach,
            ...
            txt_bgtlactchem,txt_bgtlactmach,txt_bgtlactequip,txt_bgtlactToi,txt_bgtlactPrd,txt_bgtlactLand,txt_bgtlactSub,txt_bgtlactOther = null;
        ...
        private void Refresh_Budget()
        {
            ...
            {
                txt_bgtsactctr.Text = Convert.ToString(ctrh["bgtActMctr"]);
            }
            if (BizFunctions.IsEmpty(txt_bgtsactLand.Text))
            {
                txt_bgtsactLand.Text = Convert.ToString(ctrh["bgtActMLand"]);
            }
            if (BizFunctions.IsEmpty(txt_bgtsactSub.Text))
            {
                txt_bgtsactSub.Text = Convert.ToString(ctrh["bgtActMSub"]);
            }
            if (BizFunctions.IsEmpty(txt_bgtsactOther.Text))
            {
                txt_bgtsactOther.Text = Convert.ToString(ctrh["bgtActMOther"]);
            }
            #endregion
            ...
            {
                txt_bgtactctr.Text = Convert.ToString(ctrh["bgtActMctr"]);
            }
            ...
            {
                txt_bgtactsal.Text = Convert.ToString(ctrh["bgtActMsal"]);
            }
            ...
            {
                txt_bgtactmat.Text = Convert.ToString(ctrh["bgtActMmat"]);
            }
            ...
            {
                txt_bgtactchem.Text = Convert.ToString(ctrh["bgtActMchem"]);
            }
            ...
            {
                txt_bgtactmach.Text = Convert.ToString(ctrh["bgtActMmach"]);
            }
            ...
            {
                txt_bgtactequip.Text = Convert.ToString(ctrh["bgtActMequip"]);
            }
            ...
            {
                txt_bgtactToi.Text = Convert.ToString(ctrh["bgtActMToi"]);
            }
            ...
            {
                txt_bgtactPrd.Text = Convert.ToString(ctrh["bgtActMPrd"]);
            }
            ...
            {
                txt_bgtactLand.Text = Convert.ToString(ctrh["bgtActMLand"]);
            }
            ...
            {
                txt_bgtactSub.Text = Convert.ToString(ctrh["bgtActMSub"]);
            }
            ...
            {
                txt_bgtactOther.Text = Convert.ToString(ctrh["bgtActMOther"]);
            }
            ...
            if (!BizFunctions.IsEmpty(ctrh["bgtActMPrd"]))
            {
                txt_bgtlactPrd.Text = Convert.ToString(ctrh["bgtActMPrd"]);
            }
            if (!BizFunctions.IsEmpty(ctrh["bgtActMLand"]))
            {
                txt_bgtlactLand.Text = Convert.ToString(ctrh["bgtActMLand"]);
            }
            if (!BizFunctions.IsEmpty(ctrh["bgtActMSub"]))
            {
                txt_bgtlactSub.Text = Convert.ToString(ctrh["bgtActMSub"]);
            }
            if (!BizFunctions.IsEmpty(ctrh["bgtActMOther"]))
            {
                txt_bgtlactOther.Text = Convert.ToString(ctrh["bgtActMOther"]);
            }
            #endregion
