...
namespace ATL.HSAM
{
    public class Voucher_HSAM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_HSAM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_HSAM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
