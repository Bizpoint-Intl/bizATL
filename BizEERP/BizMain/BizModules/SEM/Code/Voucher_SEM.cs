...
namespace ATL.SEM
{
    public class Voucher_SEM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_SEM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_SEM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
