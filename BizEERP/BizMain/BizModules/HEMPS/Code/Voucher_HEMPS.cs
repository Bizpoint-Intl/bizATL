...
namespace ATL.HEMPS
{
    public class Voucher_HEMPS : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_HEMPS(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_HEMPS.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
