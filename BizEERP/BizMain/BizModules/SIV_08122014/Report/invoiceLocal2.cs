...
namespace ATL.BizModules.SIV_08122014.Report {
    ...
    public class invoiceLocal2 : ReportClass {
        
        public invoiceLocal2() {
        }
        
        public override string ResourceName {
            get {
                return "invoiceLocal2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedinvoiceLocal2 : Component, ICachedReport {
        
        public CachedinvoiceLocal2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            invoiceLocal2 rpt = new invoiceLocal2();
            rpt.Site = this.Site;
            return rpt;
        }
