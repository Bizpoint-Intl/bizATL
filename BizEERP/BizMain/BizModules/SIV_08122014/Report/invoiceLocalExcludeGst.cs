...
namespace ATL.BizModules.SIV_08122014.Report {
    ...
    public class invoiceLocalExcludeGst : ReportClass {
        
        public invoiceLocalExcludeGst() {
        }
        
        public override string ResourceName {
            get {
                return "invoiceLocalExcludeGst.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedinvoiceLocalExcludeGst : Component, ICachedReport {
        
        public CachedinvoiceLocalExcludeGst() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            invoiceLocalExcludeGst rpt = new invoiceLocalExcludeGst();
            rpt.Site = this.Site;
            return rpt;
        }
