...
namespace PicoGuards.Name
{
    public class Voucher_Name : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_Name(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_NAME.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
