...
namespace ATL.HSGM
{
    public class Voucher_HSGM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_HSGM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_HSGM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
