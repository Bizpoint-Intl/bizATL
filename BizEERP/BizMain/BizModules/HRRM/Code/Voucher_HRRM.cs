...
namespace ATL.HRRM
{
    public class Voucher_HRRM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_HRRM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_HRRM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
