                                ...
                                if (dr2.RowState != DataRowState.Deleted)
                                {
                                    if (!BizFunctions.IsEmpty(dr2["uniquekey"]))
                                    {
                                        if (dr1["uniquekey"].ToString() == dr2["uniquekey"].ToString())
                                        {
                                            ...
                                            //string empnum1 = dr1["empnum"].ToString();
                                            //string empnum2 = dr2["empnum"].ToString();

                                            //string shiftcode1 = dr1["shiftcode"].ToString();
                                            //string shiftcode2 = dr2["shiftcode"].ToString();

                                            //string actualDateTimeIn1 = dr1["ActualDateTimeIn"].ToString();
                                            //string actualDateTimeIn2 = dr2["ActualDateTimeIn"].ToString();

                                            //string actualDateTimeOut1 = dr1["ActualDateTimeOut"].ToString();
                                            //string actualDateTimeOut2 = dr2["ActualDateTimeOut"].ToString();
