...
{
    public partial class TimeControlForm2 : Form
    {
        ...
        private void GetSchedule()
        {
            ...
            {
                GetCurrentSchedule = "Select * from atmrlive where  refnum='" + WRRrefNoTb.Text + "' AND [date]='" + TimeTools.GetStandardSafeDateOnly2(Convert.ToDateTime(dateTimePicker1.Text)) + "'";
