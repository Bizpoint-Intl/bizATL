...
namespace ATL.HEMP
{
    public class Voucher_HEMP : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        protected Button btn_Voucher_Reports, Btn_Contract,Btn_Picture, columnButton1, columnButton2 = null;
        protected DataGrid SalHistorydatagrid, EmpHistorydatagrid, SalRecordDG, dg_warning, dg_appraise = null;
        ...
        protected string gender, tabName, headerFormName, eduFormName, salFormname, permitsFormName, employmentrecFormName,contactsinfoFormName,
                          experienceFormName, familyFormName, incetiveFormName, cidclearancesFormName, archiveFormName, warningFormName, leaveFormName, trainingFormName, appraiseFormName = null;
        ...
        private void GetAppraisalHistory()
        {
            ...
            if (!BizFunctions.IsEmpty(hemph["empnum"]))
            {
                ...
                string getAppraisalStr = "SELECT " +
                                        "refnum,ttscore as [Total Score],ttmaxscore as [Total Max Score],ttfactors as [Total Factor],  " +
                                        "CASE WHEN ttscore>0 and ttfactors>0 then ttscore/ttfactors END as [Total Avg Factor] " +
                                    "FROM " +
                                    "( " +
                                        "select s1.refnum,SUM(ISNULL(s1.score,0)) as ttscore, SUM(ISNULL(s1.maxscore,0)) as ttmaxscore, count(*) as ttfactors  " +
                                        ...
                                        "GROUP BY s1.refnum " +
                                    ")A " +
                                    "group by refnum,ttscore,ttmaxscore,ttfactors";
            ...
            dg_appraise.CaptionText = "Salary History";
        }
