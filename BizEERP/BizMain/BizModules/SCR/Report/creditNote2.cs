...
namespace ATL.BizModules.SCR.Report {
    ...
    public class creditNote2 : ReportClass {
    ...
    public class CachedcreditNote2 : Component, ICachedReport {
        
        public CachedcreditNote2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            creditNote2 rpt = new creditNote2();
            rpt.Site = this.Site;
            return rpt;
        }
