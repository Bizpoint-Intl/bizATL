...
namespace ATL.ACMG
{
    public class Voucher_ACMG : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_ACMG(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_ACMG.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
