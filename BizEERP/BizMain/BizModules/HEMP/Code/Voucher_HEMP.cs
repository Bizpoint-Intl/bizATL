...
namespace ATL.HEMP
{
    public class Voucher_HEMP : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        protected Button btn_Voucher_Reports, Btn_Contract, Btn_Picture, columnButton1, columnButton2, permitdocColumnUpButton, permitdocColumnDownButton, docColumnUpButton, docColumnPrevButton, eduUpColumnButton, eduDownColumnButton = null;
        protected DataGrid SalHistorydatagrid, EmpHistorydatagrid, SalRecordDG, dg_warning, dg_appraise, dg_archive, dg_education, dg_leaverec, dg_request, dg_permits, dg_salary, dg_experience, dg_family = null;
        ...
        protected string archivefilename, edufilename, permitfilename = "";
        ...
        protected string gender, tabName, headerFormName, eduFormName, salFormname, permitsFormName, employmentrecFormName,contactsinfoFormName,archiveFormName,
                          experienceFormName, familyFormName, incetiveFormName, cidclearancesFormName, warningFormName, leaveFormName, trainingFormName, appraiseFormName = null;
        ...
        protected bool isRefreshed,fromSADJ, reOpen;
        protected bool opened, isMouseClicked, enableDocSave,isVoided = false;
        ...
        public Voucher_HEMP(string moduleName, Hashtable voucherBaseHelpers, string hFlag) : base("VoucherGridInfo_HEMP.xml", moduleName, voucherBaseHelpers)
        {
            this.EmpFlag = hFlag;
        }
        #endregion Construct
        ...
        protected override void Document_Form_OnLoad(object sender, DocumentEventArgs e)
        {
            ...
            this.appraiseFormName = (e.FormsCollection["appraise"] as Form).Name;
            ...
            dg_appraise = BizXmlReader.CurrentInstance.GetControl(appraiseFormName, "dg_appraise") as DataGrid;
            ...
            //docColumnUpButton, docColumnPrevButton
            dg_archive = (DataGrid)BizXmlReader.CurrentInstance.GetControl(archiveFormName, "dg_archive");

            foreach (DataGridTableStyle dataGridTableStyle in dg_archive.TableStyles)
            {
                foreach (DataGridColumnStyle dataGridColumnStyle in dataGridTableStyle.GridColumnStyles)
                {
                    ...
                    if (dataGridColumnStyle is BizDataGridTextBoxColumn)
                    {
                        ...
                        if (bizDataGridTextBoxColumn.MappingName == "button1")
                        {
                            bizDataGridTextBoxColumn.Alignment = HorizontalAlignment.Center;
                            bizDataGridTextBoxColumn.TextBoxGrid.BackColor = Color.FromKnownColor(KnownColor.Control);
                            docColumnUpButton = new Button();
                            docColumnUpButton.Text = "Upload";
                            docColumnUpButton.FlatStyle = FlatStyle.Standard;
                            docColumnUpButton.BackColor = Color.FromKnownColor(KnownColor.Control);
                            docColumnUpButton.Size = new Size(75, 14);
                            docColumnUpButton.Click += new EventHandler(docColumnUpButton_Click);

                            bizDataGridTextBoxColumn.TextBoxGrid.Controls.Add(docColumnUpButton);
                        }
                        ...
                        if (bizDataGridTextBoxColumn.MappingName == "button2")
                        {
                            bizDataGridTextBoxColumn.Alignment = HorizontalAlignment.Center;
                            bizDataGridTextBoxColumn.TextBoxGrid.BackColor = Color.FromKnownColor(KnownColor.Control);
                            docColumnPrevButton = new Button();
                            docColumnPrevButton.Text = "Preview";
                            docColumnPrevButton.FlatStyle = FlatStyle.Standard;
                            docColumnPrevButton.BackColor = Color.FromKnownColor(KnownColor.Control);
                            docColumnPrevButton.Size = new Size(75, 14);
                            docColumnPrevButton.Click += new EventHandler(docColumnPrevButton_Click);

                            bizDataGridTextBoxColumn.TextBoxGrid.Controls.Add(docColumnPrevButton);
                        }
                    }
                }
            }

            dg_education = (DataGrid)BizXmlReader.CurrentInstance.GetControl(eduFormName, "dg_Education");
            ...
            foreach (DataGridTableStyle dataGridTableStyle1 in dg_education.TableStyles)
            {
                foreach (DataGridColumnStyle dataGridColumnStyle1 in dataGridTableStyle1.GridColumnStyles)
                {
                    if (dataGridColumnStyle1 is BizDataGridTextBoxColumn)
                    {
                        ...
                        if (bizDataGridTextBoxColumn1.MappingName == "button1")
                        {
                            bizDataGridTextBoxColumn1.Alignment = HorizontalAlignment.Center;
                            bizDataGridTextBoxColumn1.TextBoxGrid.BackColor = Color.FromKnownColor(KnownColor.Control);
                            eduUpColumnButton = new Button();
                            eduUpColumnButton.Text = "Upload";
                            eduUpColumnButton.FlatStyle = FlatStyle.Standard;
                            eduUpColumnButton.BackColor = Color.FromKnownColor(KnownColor.Control);
                            eduUpColumnButton.Size = new Size(75, 14);
                            eduUpColumnButton.Click += new EventHandler(eduUpColumnButton_Click);

                            bizDataGridTextBoxColumn1.TextBoxGrid.Controls.Add(eduUpColumnButton);
                        }


                        if (bizDataGridTextBoxColumn1.MappingName == "button2")
                        {
                            bizDataGridTextBoxColumn1.Alignment = HorizontalAlignment.Center;
                            bizDataGridTextBoxColumn1.TextBoxGrid.BackColor = Color.FromKnownColor(KnownColor.Control);
                            eduDownColumnButton = new Button();
                            eduDownColumnButton.Text = "Preview";
                            eduDownColumnButton.FlatStyle = FlatStyle.Standard;
                            eduDownColumnButton.BackColor = Color.FromKnownColor(KnownColor.Control);
                            eduDownColumnButton.Size = new Size(75, 14);
                            eduDownColumnButton.Click += new EventHandler(eduDownColumnButton_Click);

                            bizDataGridTextBoxColumn1.TextBoxGrid.Controls.Add(eduDownColumnButton);
                        }
                    }
            ...
            //////////////////////////////////////////////
            dg_salary = (DataGrid)BizXmlReader.CurrentInstance.GetControl(salFormname, "dg_Salaryrec");
            ...
            //////////////////////////////////////////////
            dg_permits = (DataGrid)BizXmlReader.CurrentInstance.GetControl(permitsFormName, "dg_Permitslicences");
            ...
            foreach (DataGridTableStyle dataGridTableStyle3 in dg_permits.TableStyles)
            {
                foreach (DataGridColumnStyle dataGridColumnStyle3 in dataGridTableStyle3.GridColumnStyles)
                {
                    ...
                    if (dataGridColumnStyle3 is BizDataGridTextBoxColumn)
                    {
                        BizDataGridTextBoxColumn bizDataGridTextBoxColumn = dataGridColumnStyle3 as BizDataGridTextBoxColumn;

                        if (bizDataGridTextBoxColumn.MappingName == "button1")
                        {
                            bizDataGridTextBoxColumn.Alignment = HorizontalAlignment.Center;
                            bizDataGridTextBoxColumn.TextBoxGrid.BackColor = Color.FromKnownColor(KnownColor.Control);
                            permitdocColumnUpButton = new Button();
                            permitdocColumnUpButton.Text = "Upload";
                            permitdocColumnUpButton.FlatStyle = FlatStyle.Standard;
                            permitdocColumnUpButton.BackColor = Color.FromKnownColor(KnownColor.Control);
                            permitdocColumnUpButton.Size = new Size(75, 14);
                            permitdocColumnUpButton.Click += new EventHandler(permitdocColumnUpButton_Click);

                            bizDataGridTextBoxColumn.TextBoxGrid.Controls.Add(permitdocColumnUpButton);
                        }
                        ...
                        if (bizDataGridTextBoxColumn.MappingName == "button2")
                        {
                            bizDataGridTextBoxColumn.Alignment = HorizontalAlignment.Center;
                            bizDataGridTextBoxColumn.TextBoxGrid.BackColor = Color.FromKnownColor(KnownColor.Control);
                            permitdocColumnDownButton = new Button();
                            permitdocColumnDownButton.Text = "Preview";
                            permitdocColumnDownButton.FlatStyle = FlatStyle.Standard;
                            permitdocColumnDownButton.BackColor = Color.FromKnownColor(KnownColor.Control);
                            permitdocColumnDownButton.Size = new Size(75, 14);
                            permitdocColumnDownButton.Click += new EventHandler(permitdocColumnDownButton_Click);

                            bizDataGridTextBoxColumn.TextBoxGrid.Controls.Add(permitdocColumnDownButton);
                        }
                    }
            ...
            //////////////////////////////////////////////
            dg_experience = (DataGrid)BizXmlReader.CurrentInstance.GetControl(experienceFormName, "dg_Experience");
            ...
            //////////////////////////////////////////////
            dg_family = (DataGrid)BizXmlReader.CurrentInstance.GetControl(familyFormName, "dg_Family");
            ...
            e.DBAccess.DataSet.Tables["hemp2"].ColumnChanged += new DataColumnChangeEventHandler(Voucher_HEMP2_ColumnChanged);
            e.DBAccess.DataSet.Tables["hemph"].ColumnChanged += new DataColumnChangeEventHandler(Voucher_HEMPH_ColumnChanged);
            ...
            if (BizFunctions.IsEmpty(hemph["paytypecode"]))
            {
                hemph["paytypecode"] = "MONTHLY PAY";
            }                      
        }
        ...
        private void Voucher_FAMR_ColumnChanged(object sender, DataColumnChangeEventArgs e)
        {
            ...
            switch (e.Column.ColumnName)
            {
                case "isemergency":
                    {
                        if (!BizFunctions.IsEmpty(e.Row["isemergency"]))
                        {
                            if (!(bool)e.Row["isemergency"])
                            
                                if (hemph["emgName"].ToString().Trim() == e.Row["name"].ToString().Trim())
                                {
                                    hemph["emgName"] = string.Empty;
                                    hemph["emgContact"] = string.Empty;
                                    hemph["emgRelationship"] = string.Empty;
                                }
                            }
                        }
                ...
                case "yearfinished":
                    {
                        if (PFMEDU.Rows.Count > 0)
                        {
                            if (!BizFunctions.IsEmpty(PFMEDU.Rows[dg_education.CurrentCell.RowNumber]["yearfinished"]))
                            {
                                int n;
                                bool isNumeric = int.TryParse(PFMEDU.Rows[dg_education.CurrentCell.RowNumber]["yearfinished"].ToString().Trim(), out n);

                                if (!isNumeric)
                                {
                                    MessageBox.Show("Please key in again", "Invalid Year", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                    PFMEDU.Rows[dg_education.CurrentCell.RowNumber]["yearfinished"] = System.DBNull.Value;
                                ...
                                else
                                {
                                    ...
                                    stringLength = PFMEDU.Rows[dg_education.CurrentCell.RowNumber]["yearfinished"].ToString().Trim().Length;
                            ...
                            //foreach (DataRow dr1 in PFMEDU.Rows)
                            //{
                            //    if (dr1.RowState != DataRowState.Deleted)
                            //    {
        ...
        private void Voucher_HEMP2_ColumnChanged(object sender, DataColumnChangeEventArgs e)
        {
            DataRow hemph = this.dbaccess.DataSet.Tables["hemph"].Rows[0];
            DataTable hemp2 = this.dbaccess.DataSet.Tables["HEMP2"];

            switch (e.Column.ColumnName)
            {
                case "isLatest":
                    {
                        if (!BizFunctions.IsEmpty(e.Row["nationality"]))
                        {
                            if (e.Row["nationality"].ToString().ToUpper().Trim() == "SINGAPOREAN")
                            {
                                hemph["nrictype"] = "PINK";
                            }
                            else if (e.Row["nationality"].ToString().ToUpper().Trim() == "SINGAPOREPR")
                            {
                                hemph["nrictype"] = "BLUE";
                            }
                        }
                ...
                case "nationality":
                    {
                        if (!BizFunctions.IsEmpty(e.Row["nationality"]))
                        {
                            if (e.Row["nationality"].ToString().ToUpper().Trim() == "SINGAPOREAN")
                            {
                                if (BizFunctions.IsEmpty(e.Row["isLatest"]))
                                {
                                    e.Row["isLatest"] = 0;
                                }

                                if ((bool)e.Row["isLatest"])
                                {
                                    hemph["nrictype"] = "PINK";
                                }
                            }
                            else if (e.Row["nationality"].ToString().ToUpper().Trim() == "SINGAPORE PR")
                            {
                                if (BizFunctions.IsEmpty(e.Row["isLatest"]))
                                {
                                    e.Row["isLatest"] = 0;
        ...
        private void Voucher_HEMPH_ColumnChanged(object sender, DataColumnChangeEventArgs e)
        {
            DataRow hemph = this.dbaccess.DataSet.Tables["HEMPH"].Rows[0];

            switch (e.Column.ColumnName)
            {
                case "printForeignAdd":
                    {
                        if (BizFunctions.IsEmpty(hemph["printForeignAdd"]))
                        {
                            hemph["printForeignAdd"] = 0;
                        }

                        if ((bool)hemph["printForeignAdd"])
                        {
                            hemph["printLocalAdd"] = 0;
                        }
                    }
                    break;
                ...
                case "printLocalAdd":
                    {
                        if (BizFunctions.IsEmpty(hemph["printLocalAdd"]))
                        {
                            hemph["printLocalAdd"] = 0;
                        }
                        if ((bool)hemph["printLocalAdd"])
                        {
                            hemph["printForeignAdd"] = 0;
                        }
        ...
        private void Initialise()
        {
            ...
            Btn_Picture = BizXmlReader.CurrentInstance.GetControl(headerFormName, "Btn_Picture") as Button;
            Btn_Picture.Click += new EventHandler(Btn_Picture_Click);
            ...
            if (!BizFunctions.IsEmpty(hemph["statuscode"]))
            {
                if (hemph["statuscode"].ToString().Trim().ToUpper().Contains("RESIG"))
                {
                    GetResignationDate();
                }
                else if (hemph["statuscode"].ToString().Trim().ToUpper().Contains("ACTI"))
                {
                    hemph["dateresigned"] = System.DBNull.Value;
                }
            }
            else
            {
        ...
        protected void openFileDialog_UploadFileOk(object sender, System.ComponentModel.CancelEventArgs e, string filename)
        {
            DataRow hemph = this.dbaccess.DataSet.Tables["hemph"].Rows[0];
            DataTable pffa = this.dbaccess.DataSet.Tables["pffa"];
        ...
        void Btn_Picture_Click(object sender, EventArgs e)
        {
            DataRow hemph = this.dbaccess.DataSet.Tables["HEMPH"].Rows[0];
            DataTable hemp1 = this.dbaccess.DataSet.Tables["HEMP1"];

            ATL.ExtractHEMPpics1.ExtractHEMPpics1 Ehemph = new ATL.ExtractHEMPpics1.ExtractHEMPpics1(dbaccess, hemph["empnum"].ToString());
            ...
            if (wlr.Rows.Count > 0)
            {
                ...
                string str = "Select " +
                            ...
                            "( " +
                                ...
                                "LEFT JOIN " +
                                "( " +
                                "Select top 1 empnum,name,contact from FAMR where empnum='" + hemph["empnum"].ToString().Trim() + "' " +
                                ")FM " +
        ...
        protected override void Document_Save_Handle(object sender, DocumentHandleEventArgs e)
        {
            ...
            if (!BizFunctions.IsEmpty(hemph["appliFormSigLoc"]))
            {
                string str1 = hemph["appliFormSigLoc"].ToString().Trim();

                if(!hemph["appliFormSigLoc"].ToString().Contains(@"\\192.168.1.11\$atl\"))
                {
                    hemph["appliFormSigLoc"] = @"\\192.168.1.11\$atl\" + hemph["appliFormSigLoc"].ToString();
                }
            }

            if (BizFunctions.IsEmpty(hemph["created"]))
            {
                hemph["created"] = DateTime.Now;
            }

            if (BizFunctions.IsEmpty(hemph["modified"]))
            {
                hemph["modified"] = DateTime.Now;
            }

            if (BizFunctions.IsEmpty(hemph["bankacc"]))
            {
                hemph["bankacc"] = "-";
            }
            else if (hemph["bankacc"].ToString().Trim() == string.Empty)
            {
                hemph["bankacc"] = "-";
            }

            if (BizFunctions.IsEmpty(hemph["ContactHouse"]))
            {
                hemph["ContactHouse"] = "-";
            }
            else if (hemph["ContactHouse"].ToString().Trim() == string.Empty)
            {
                hemph["ContactHouse"] = "-";
            }

            if (BizFunctions.IsEmpty(hemph["contact"]))
            {
                hemph["contact"] = "-";
            }
            else if (hemph["contact"].ToString().Trim() == string.Empty)
            {
                hemph["contact"] = "-";
            }
            //if (BizFunctions.IsEmpty(hemph["BankCode"]))
            //{
            //    hemph["BankCode"] = "-";

            //}
            //if (BizFunctions.IsEmpty(hemph["BranchCode"]))
            //{
            //    hemph["BranchCode"] = "-";
         ...
         //   }
           ...
           ///
            ...
            if (e.Handle && pfmsr.Rows.Count > 0)
            {
                foreach (DataRow dr5 in pfmsr.Rows)
                {
                    ...
                    if (dr5.RowState != DataRowState.Deleted)
                    {
                        ...
                        {
                            BizFunctions.UpdateDataRow(hemph, dr5, "empnum/nric/user/status/createdby/created/modified/hsgcode");
                        }
                    }
                }
            }
            ...
            SetLatestNationality();
            SetIsEmergencyContact();


            string test1 = hemph["interviewedby"].ToString();
            string test2 = hemph["approveby"].ToString();
            if (!BizFunctions.IsEmpty(hemph["interviewedby"]))
            {
                DataRow dr = BizLogicTools.Tools.GetCommonEmpDataRow(hemph["interviewedby"].ToString());

                if (dr != null)
                {

                    hemph["interviewername"] = dr["empname"];
                }
                //hemph["interviewername"] = BizLogicTools.Tools. hemph["interviewedby"];
            }

            if (!BizFunctions.IsEmpty(hemph["approveby"]))
            {
                DataRow dr = BizLogicTools.Tools.GetCommonEmpDataRow(hemph["approveby"].ToString());
                if (dr != null)
                {
                    hemph["approvename"] = dr["empname"];
                }
                //hemph["interviewername"] = BizLogicTools.Tools. hemph["interviewedby"];
            }
            bool hasOT = false;
            if (pfmsr.Rows.Count > 0)
            {
                foreach (DataRow pfmsrDr1 in pfmsr.Rows)
                {
                    if (pfmsrDr1.RowState != DataRowState.Deleted)
                    {
                        if (pfmsrDr1["hsamcode"].ToString().ToUpper().Contains("OTALLW"))
                        {
                            hasOT = true;
                        }
                    }
            ...
            if (BizFunctions.IsEmpty(hemph["salaryremark"]))
            {
                if (hemph["paytypecode"].ToString() == "DAILY PAY")
                {
                    hemph["salaryremark"] = "Gross Salary depends on number of days worked";
                }
                //else if (hasOT)
                //{
                //    hemph["salaryremark"] = "OVERTIME";
                //}
                else
                {
                    hemph["salaryremark"] = "-";
            ...
            else if (hemph["paytypecode"].ToString() == "DAILY PAY" && BizFunctions.IsEmpty(hemph["salaryremark"]))
            {
                hemph["salaryremark"] = "Gross Salary depends on number of days worked";
            }
                ...
                case "hemph_sitenumt":
                    {
                        ...
                        e.Condition = BizFunctions.F2Condition("sitenumt,sitenumt", (sender as TextBox).Text);
                        //e.DefaultCondition = "matnum like '" + hemph["matnum"].ToString() + "%' OR matname like '" + hemph["matnum"].ToString() + "%'";
        ...
        protected override void Document_SaveBegin_OnClick(object sender, DocumentEventArgs e)
        {
            ...
            {
                if (hemph["hsgcode"].ToString().Trim() == "L3" && hemph["flag"].ToString() == "HEMP")
                {
                    DataTable dtempnum = dbaccess.ReadSQLTemp("dtempnum", "select isnull(max(empnum),0) as empnum from HEMPH where flag ='HEMP'").Tables["dtempnum"];
                    int code = Int32.Parse(dtempnum.Rows[0]["empnum"].ToString()) + 1;
                    hemph["empnum"] = code.ToString("D5");
                }
                else {

                    DataTable dtempnum1 = dbaccess.ReadSQLTemp("dtempnum", "select isnull(max(empnum),0) as empnum from HEMPH where flag ='HEMPHQ'").Tables["dtempnum"];
                    int code1 = Int32.Parse(dtempnum1.Rows[0]["empnum"].ToString()) + 1;
                    hemph["empnum"] = code1.ToString("D5");
            ...
            string getPhotoUrl = "Select top 1 photourl from hemp1 where remark LIKE 'Photo%' and empnum='"+hemph["empnum"].ToString()+"'";

            this.dbaccess.ReadSQL("PhotoURLtmp", getPhotoUrl);

            DataTable PhotoURLtmp = this.dbaccess.DataSet.Tables["PhotoURLtmp"];

            DataRow drPhotoUrl = null;

            if (PhotoURLtmp.Rows.Count > 0)
            {
                drPhotoUrl = this.dbaccess.DataSet.Tables["PhotoURLtmp"].Rows[0];
            }

            if (drPhotoUrl != null)
            {
                if (pb.Image == null && !BizFunctions.IsEmpty(drPhotoUrl["photourl"]) && BizFunctions.IsEmpty(hemph["photo"]))
                {
                    pb.SizeMode = PictureBoxSizeMode.StretchImage;
                    Image img = Image.FromFile(drPhotoUrl["photourl"].ToString());
                    pb.Image = img;
                }
                else if (pb.Image == null && BizFunctions.IsEmpty(drPhotoUrl["photourl"]) && BizFunctions.IsEmpty(hemph["photo"]))
                {
                    pb.SizeMode = PictureBoxSizeMode.StretchImage;
                    string projectPath = ConfigurationManager.AppSettings.Get("ImagePath");
                    Image img = Image.FromFile(projectPath + @"\noimage.JPG");
            ...
            else if (pb.Image == null && BizFunctions.IsEmpty(hemph["photo"]))
            {
                pb.SizeMode = PictureBoxSizeMode.StretchImage;
                string projectPath = ConfigurationManager.AppSettings.Get("ImagePath");
                Image img = Image.FromFile(projectPath + @"\noimage.JPG");
        ...
        protected override void Document_SaveEnd_OnClick(object sender, DocumentEventArgs e)
        {
            ...
            if (!BizFunctions.IsEmpty(hemph["sitenum"]))
            {
                if (!isVoided)
                {
                    if (!BizFunctions.IsEmpty(hemph["sitenumt"]))
                    {
                        if (!ExistInTemplate())
                        {
                            int GetMaxID = BizLogicTools.Tools.getMaxID("SITMT8", this.dbaccess);

                            string getSiteTemplate1 = "Select * from sitmt where sitenum='" + hemph["sitenum"].ToString() + "' and [status]<>'V' ";

                            this.dbaccess.ReadSQL("TempSitmtMain1", getSiteTemplate1);

                            DataTable TempSitmtMain1 = this.dbaccess.DataSet.Tables["TempSitmtMain1"];
                            ...
                            string InsertEmp = " INSERT INTO SITMT8 " +
                                               ...
                                               " " + Convert.ToString(GetMaxID + 1) + " " +
                                                ",'" + hemph["empnum"].ToString() + "' " +
                                                ",'" + BizLogicTools.Tools.GetEmpname(hemph["empnum"].ToString(), this.dbaccess) + "' " +
                                                ",'" + hemph["matnum"].ToString() + "' " +
                                               ",'" + hemph["sitenum"].ToString() + "' " +
                                               ",'" + hemph["sitenumt"].ToString() + "' " +
                                               ",'" + TempSitmtMain1.Rows[0]["ctrnum"].ToString() + "' " +
                                               ",'Starting site on " + hemph["datejoined"].ToString() + "' " +
                                               ",'" + hemph["MonToFriShiftCode"].ToString() + "' " +
                                               ",'" + hemph["MonToFriShiftCode"].ToString() + "' " +
                                               ",'" + hemph["MonToFriShiftCode"].ToString() + "' " +
                                               ",'" + hemph["MonToFriShiftCode"].ToString() + "' " +
                                               ",'" + hemph["MonToFriShiftCode"].ToString() + "' " +
                                               ",'" + hemph["SatShiftCode"].ToString() + "' " +
                                               ",'" + hemph["SunShiftCode"].ToString() + "' " +
                                               ",'" + hemph["PHShiftCode"].ToString() + "' " +
                    ...
                    else
                    {
                        ...
                        string getSiteTemplate2 = "Select * from sitmt where sitenum='" + hemph["sitenum"].ToString() + "' and [status]<>'V' ";

                        this.dbaccess.ReadSQL("TempSitmtMain2", getSiteTemplate2);

                        DataTable TempSitmtMain2 = this.dbaccess.DataSet.Tables["TempSitmtMain2"];

                        if (TempSitmtMain2.Rows.Count > 0)
                        {
                            if (hemph["statuscode"].ToString().Trim().ToUpper().Contains("ACTIV"))
                            {
                                if (!ExistInTemplate())
                                {
                                    string InsertEmp = " INSERT INTO SITMT8 " +
                                                       ...
                                                       " " + Convert.ToString(GetMaxID + 1) + " " +
                                                        ...
                                                        ",'" + BizLogicTools.Tools.GetEmpname(hemph["empnum"].ToString(), this.dbaccess) + "' " +
                                                        ",'" + hemph["matnum"].ToString() + "' " +
                                                       ",'" + TempSitmtMain2.Rows[0]["sitenum"].ToString() + "' " +
                                                       ",'" + TempSitmtMain2.Rows[0]["sitenumt"].ToString() + "' " +
                                                       ",'" + TempSitmtMain2.Rows[0]["ctrnum"].ToString() + "' " +
                                                       ",'Starting site on " + hemph["datejoined"].ToString() + "' " +
                                                       ",'" + hemph["MonToFriShiftCode"].ToString() + "' " +
                                                       ",'" + hemph["MonToFriShiftCode"].ToString() + "' " +
                                                       ",'" + hemph["MonToFriShiftCode"].ToString() + "' " +
            ...
            if (isVoided)
            {
                string deleteFromSitmt8 = "Delete from sitmt8 where empnum='" + hemph["empnum"].ToString().Trim() + "'";
                this.dbaccess.RemoteStandardSQL.ExecuteNonQuery(deleteFromSitmt8);
                isVoided = false;
            }
        ...
        private bool ExistInTemplate()
        {
            ...
            string sql = "Select * from sitmt8 where empnum='" + hemph["empnum"].ToString() + "' and [status]<>'V'";

            this.dbaccess.ReadSQL("TmpSitmt8Emp", sql);

            DataTable dt1 = this.dbaccess.DataSet.Tables["TmpSitmt8Emp"];
        ...
        protected override void Document_Refresh_OnClick(object sender, DocumentEventArgs e)
        {
            ...
            if (!BizFunctions.IsEmpty(hemph["gender"]))
            {
                if (hemph["gender"].ToString().Trim().ToUpper() == "M")
                {
                    hemph["salutationCode"] = "MR";
                }
                if (hemph["gender"].ToString().Trim().ToUpper() == "F")
                {
                    hemph["salutationCode"] = "MS";
                }
            }
        ...
        protected override void Document_Print_OnClick(object sender, DocumentPrintEventArgs e)
        {
            ...
            switch (e.ReportName)
            {
                ...
                case "Application Form":
                         ...
                         "( " +
                             "Select  " +
                                ...
                                "CASE WHEN h.ContactHouse IS NULL THEN '-' ELSE h.ContactHouse END as homecontactno, " +
                                 ...
                                 "(Select top 1 rateamt from PFMSR where PFMSR.hsamcode='DRIVTRANSALLW' and PFMSR.empnum=h.empnum) as [DRIVTRANSALLW], " +
                                 "(Select top 1 rateamt from PFMSR where PFMSR.hsamcode='OTALLW' and PFMSR.empnum=h.empnum) as [OTALLW], " +       
                                 //"(Select top 1 rateamt from PFMSR where PFMSR.hsamcode='OTHER' and PFMSR.empnum=h.empnum) as OtherAllowance, " + // TO GET THE VALUE
                                 "(SELECT SUM(rateamt) FROM PFMSR WHERE PFMSR.empnum=h.empnum and PFMSR.hsamcode NOT IN ('DRIVTRANSALLW','ACCOMALLW','ATTNALLW','BASIC') and (PFMSR.hsamcode LIKE '%ALLW' OR PFMSR.hsamcode='OTHER')) as OtherAllowance,  " +
                                 "h.remark, " +
                                "CASE WHEN FM.name IS NULL THEN '-' ELSE FM.name END as NextOfKeen, " +
                                "CASE WHEN FM.contact IS NULL THEN '-' ELSE FM.contact END as FamilyContact " +
                             "from hemph h " +
                    ...
                    string strRace = "Select * from HRAM where hramnum='" + hemph["hramdesc"].ToString().Trim() + "' ";
                    string strRelgion = "Select * from HRRM where religion='" + hemph["religion"].ToString().Trim() + "'";
                Hashtable selectedCollection = new Hashtable();
                selectedCollection.Add("LetterAppointment", str);
                selectedCollection.Add("HRAM", strRace);
                selectedCollection.Add("HRRM", strRelgion);
                this.dbaccess.ReadSQL(selectedCollection);
        ...
        private void GetWarningSignature(string guid)
        {
            DataTable wlr = this.dbaccess.DataSet.Tables["WLR"];
        ...
        private void GetPhotos()
        {
            ...
            this.dbaccess.ReadSQL("PhotoTB","Select empnum, photourl,orderno,position from hemp1 where empnum='"+hemph["empnum"].ToString()+"' and ISNULL(isappear,0)=1 order by orderno");

            DataTable PhotoTB = this.dbaccess.DataSet.Tables["PhotoTB"];
     
            

            if (!PhotoTB.Columns.Contains("Photo1"))
            {
                PhotoTB.Columns.Add("Photo1", typeof(Byte[]));
            }


            if (PhotoTB.Rows.Count > 0)
            {
                foreach (DataRow dr1 in PhotoTB.Rows)
                {
                    if (dr1.RowState != DataRowState.Deleted)
                    {
            ...
            if (this.dbaccess.DataSet.Tables.Contains("PhotoTB"))
            {
                this.dbaccess.DataSet.Tables["PhotoTB"].Dispose();
                this.dbaccess.DataSet.Tables.Remove("PhotoTB");
                this.dbaccess.DataSet.Tables.Add(PhotoTB);
        ...
        private DataSet LAds1()
        {
            ...
            string str = "Select "+
                        ...
                        "( "+
	                        ...
	                        "LEFT JOIN "+
	                        "( "+
                            "Select top 1 empnum,name,contact from FAMR where empnum='" + hemph["empnum"].ToString().Trim() + "' and ISNULL(isemergency,0)=1 " +
	                        ")FM "+
	                        "ON h.empnum=FM.empnum "+
	                        "LEFT JOIN MATM M  "+
	                        "ON h.matnum=M.matnum "+
            ...
            string str1 = "Select h.empname,h.nric, m.matname, h.giroReason from hemph h left join matm m on h.matnum=m.matnum where h.empnum='" + hemph["empnum"].ToString() + "' ";

            this.dbaccess.ReadSQL("GiroOptOut", str1);
            
            DataTable GiroOptOut = this.dbaccess.DataSet.Tables["GiroOptOut"];

            DataTable GiroOptOut1 = GiroOptOut.Copy();

            GiroOptOut1.TableName = "GiroOptOut1";

            if (ds1.Tables.Contains("GiroOptOut1"))
            {
                ds1.Tables["GiroOptOut1"].Dispose();
                ds1.Tables.Remove("GiroOptOut1");
                GiroOptOut1.TableName = "GiroOptOut1";
                ds1.Tables.Add(GiroOptOut1);
            }
            else
            {
                GiroOptOut1.TableName = "GiroOptOut1";
            ...
            string str2 = "Select * FROM hemph where empnum='" + hemph["empnum"].ToString() + "' ";
        ...
        private DataSet Recods1()
        {
            ...
            string strCert = "Select empnum,empname from HEMPH where empnum=dbo.[GetEmpnum] ('"+Common.DEFAULT_SYSTEM_USERNAME+"')";

            this.dbaccess.ReadSQL("CHEMPH", strCert);


            DataTable CHEMPH = this.dbaccess.DataSet.Tables["CHEMPH"];

            DataTable CHEMPH1 = CHEMPH.Copy();

            CHEMPH1.TableName = "CHEMPH1";

            if (ds1.Tables.Contains("CHEMPH1"))
            {
                ds1.Tables["CHEMPH1"].Dispose();
                ds1.Tables.Remove("CHEMPH1");
                CHEMPH1.TableName = "CHEMPH1";
                ds1.Tables.Add(CHEMPH1);
            }
            else
            {
                CHEMPH1.TableName = "CHEMPH1";
        ...
        {
            DataRow hemph = this.dbaccess.DataSet.Tables["HEMPH"].Rows[0];
            string sql1 = "select MAX(lastday) as lastday from ERRH where empnum='" + hemph["empnum"].ToString() + "' and status='P' AND ISNULL(isapproved,0)=1";
            if (!BizFunctions.IsEmpty(hemph["empnum"]))
            {
                ...
                if (dtERRH.Rows.Count > 0)
                {
                    ...
                    if (!BizFunctions.IsEmpty(drERRH["lastday"]))
                    {
        ...
        private void GetSalaryHistory()
        {
            ...
            if (!BizFunctions.IsEmpty(hemph["nric"]))
            {
                ...
                if (!resigned)
                {
                    ...
                    //jASON:23042015 - To filter by nric
                    ...
                    //               "E.Sitenum  " +
                    //           "from HEMPH H LEFT JOIN ERRH E ON H.empnum=E.empnum WHERE H.empnum='" + hemph["empnum"].ToString() + "' and E.[status]<>'V' AND E.status='P' AND ISNULL(E.isapproved,0)=1 " +
                    //           ")A " +
                    //       ")B " +
                    ...
                    string GetSalHistoryStr = "SELECT * FROM " +
                     "( " +
                         "select  " +
                             ...
                             "ISNULL(SADJmcode,'') as AdjustedCode, " +
                             "sitenum  " +
                         "from SALH where nric='" + hemph["nric"].ToString() + "' and status<>'V' group by matnum,nric,dateadjusted,refnum,SADJmcode,sitenum  " +
                         "UNION " +
                         "SELECT * FROM " +
                         "( " +
                         "select   " +
                             ...
                             "'RESIGN' AS AdjustedCode, " +
                             "E.Sitenum  " +
                         "from HEMPH H LEFT JOIN ERRH E ON H.empnum=E.empnum WHERE H.nric='" + hemph["nric"].ToString() + "' and E.[status]<>'V' AND E.status='P' AND ISNULL(E.isapproved,0)=1 " +
                         ")A " +
                     ")B " +
                     "order by b.DateAdjusted DESC";
                    ...
                    if (dtGetSalH.Rows.Count > 0)
                    {
                        ...
                        foreach(DataRow dr1 in dtGetSalH.Rows)
                        {
                             ...
                             if (dr1["refnum"].ToString().Trim() == hemph["empnum"].ToString().Trim())
                             {
                                 InsertPfmsr2["AdjustedCode"] = "ALL";
                             }
                             else
                             {
                ...
                DataTable dtGetSalH1 = this.dbaccess.DataSet.Tables["dtGetSalH"];
                if (dtGetSalH1 != null)
                {
                    if (dtGetSalH1.Rows.Count > 0)
                    {
                        //foreach (DataRow dr2 in dtGetSalH1.Rows)
                        //{
                        //    DateTime dt = Convert.ToDateTime(dr2["DateAdjusted"]);
                        //    if (Convert.ToDateTime(dr2["DateAdjusted"]) <= DateTime.Today)
                        //    {
                        //        SetLatestAdjustmentInfo(dr2["refnum"].ToString());
                        //    }
                        //}

                        //for (int i = dtGetSalH1.Rows.Count-1; i >= 0; i--)
                        //{
                        //    //DateTime dt = Convert.ToDateTime(dtGetSalH1.Rows[i]["DateAdjusted"]);
                        //    if (dtGetSalH1.Rows[i]["DateAdjusted"] != null)
                        //    {
                        
                        //        if (dtGetSalH1.Rows[i]["DateAdjusted"].ToString().Trim() != string.Empty)
                        //        {
                        //            DateTime dt1 = Convert.ToDateTime(Convert.ToDateTime(dtGetSalH1.Rows[i]["DateAdjusted"]).ToShortDateString());
                        //            //string test = dtGetSalH1.Rows[i]["refnum"].ToString();
                        //            //DateTime dt2 = DateTime.Today;
                        //            if (dt1 <= DateTime.Today)
                        //            {                                       
                        //                SetLatestAdjustmentInfo(dtGetSalH1.Rows[i]["refnum"].ToString());
                        //            }
                        //        }
                        //    }
                        //}
        ...
        private void SetLatestAdjustmentInfo(string refnum)
        {
            DataRow hemph = this.dbaccess.DataSet.Tables["hemph"].Rows[0];
            string strOtherData = "select * from sadjh where refnum='" + refnum + "'";
            string strOtherData2 = "select * from hemph where empnum='" + refnum + "'";
            this.dbaccess.ReadSQL("SalhTmp2", strOtherData);
            this.dbaccess.ReadSQL("SalhTmp3", strOtherData2);

            DataTable SalhTmp = this.dbaccess.DataSet.Tables["SalhTmp2"];

            DataTable SalhTmp3 = this.dbaccess.DataSet.Tables["SalhTmp3"];

            if (SalhTmp.Rows.Count > 0)
            {
                DataRow dr1 = this.dbaccess.DataSet.Tables["SalhTmp2"].Rows[0];

                hemph["sitenum"] = dr1["newsitenum"].ToString();
                hemph["matnum"] = dr1["newmatnum"].ToString();
                hemph["MonToFriTimeFrom"] = dr1["MonToFriTimeFrom"];
                hemph["MonToFriTimeTo"] = dr1["MonToFriTimeTo"];
                hemph["MonToFriLunchHr"] = dr1["MonToFriLunchHr"];
                hemph["MonToFriTeaBrkHr"] = dr1["MonToFriTeaBrkHr"];
                hemph["SatTimeFrom"] = dr1["SatTimeFrom"];
                hemph["SatTimeTo"] = dr1["SatTimeTo"];
                hemph["SatLunchHr"] = dr1["SatLunchHr"];
                hemph["SatTeaBrkHr"] = dr1["SatTeaBrkHr"];
                hemph["SunTimeFrom"] = dr1["SunTimeFrom"];
                hemph["SunTimeTo"] = dr1["SunTimeTo"];
                hemph["SunLunchHr"] = dr1["SunLunchHr"];
                hemph["SunTeaBrkHr"] = dr1["SunTeaBrkHr"];
                hemph["PHTimeFrom"] = dr1["PHTimeFrom"];
                hemph["PHTimeTo"] = dr1["PHTimeTo"];
                hemph["PHLunchHr"] = dr1["PHLunchHr"];
                hemph["PHTeaBrkHr"] = dr1["PHTeaBrkHr"];
                hemph["RegularOffDay"] = dr1["RegularOffDay"];
                hemph["daysperweek"] = dr1["daysperweek"];


                hemph["MonToFriShiftCode"] = dr1["newMonToFriShiftCode"];
                hemph["SatShiftCode"] = dr1["newSatShiftCode"];
                hemph["SunShiftCode"] = dr1["newSunShiftCode"];
                hemph["PHShiftCode"] = dr1["newPHShiftCode"];

                hemph["sitenumt"] = dr1["sitenumt"];
                hemph["paytypecode"] = dr1["paytypecode"];
            }
            //else if(SalhTmp3.Rows.Count > 0)
            //{
            //    DataRow dr1 = this.dbaccess.DataSet.Tables["SalhTmp3"].Rows[0];

            //    hemph["sitenum"] = dr1["sitenum"].ToString();
            //    hemph["matnum"] = dr1["matnum"].ToString();
            //    hemph["MonToFriTimeFrom"] = dr1["MonToFriTimeFrom"];
            //    hemph["MonToFriTimeTo"] = dr1["MonToFriTimeTo"];
            //    hemph["MonToFriLunchHr"] = dr1["MonToFriLunchHr"];
            //    hemph["MonToFriTeaBrkHr"] = dr1["MonToFriTeaBrkHr"];
            ...
            //    hemph["MonToFriShiftCode"] = dr1["MonToFriShiftCode"];
            //    hemph["SatShiftCode"] = dr1["SatShiftCode"];
            //    hemph["SunShiftCode"] = dr1["SunShiftCode"];
            //    hemph["PHShiftCode"] = dr1["PHShiftCode"];
        ...
        #region Get Appraisal History

        private void GetAppraisalHistory()
        {
            DataRow hemph = this.dbaccess.DataSet.Tables["HEMPH"].Rows[0];
            if (!BizFunctions.IsEmpty(hemph["empnum"]))
            {
                /// Jason 15012015
                //string getAppraisalStr = "SELECT " +
                //                        "refnum,[YEAR],ISNULL(SUM(ttscore),0) as [Total Score],ISNULL(SUM(ttmaxscore),0) as [Total Max Score],ISNULL(SUM(ttfactors),0) as [Total Factor],  " +
                //                        "CASE WHEN ttscore>0 and ttfactors>0 then ttscore/ttfactors else 0 END as [Total Avg Factor] " +
                //                    "FROM " +
                //                    "( " +
                //                        "select s1.refnum,YEAR(sh.trandate) as [Year], SUM(ISNULL(s1.score,0)) as ttscore, SUM(ISNULL(s1.maxscore,0)) as ttmaxscore, count(*) as ttfactors  " +
                //                        "from sadj1 s1 left join SADJH sh on s1.refnum=sh.refnum " +
                //                        "where sh.flag='APPR' and sh.[status]='P' and ISNULL(sh.isapproved,0)=1 and sh.empnum='" + hemph["empnum"].ToString().Trim() + "' " +
                //                        "GROUP BY s1.refnum,YEAR(sh.trandate) " +
                //                        "UNION "+
                //               "         select refnum,YEAR(trandate) as [Year],mtotalscore as ttscore,0 as ttmaxscore, 0 ttfactors   from  SADJH sh where sh.flag='APPR' and sh.[status]='P'" +
                //                "        and ISNULL(sh.isapproved,0)=1  and empnum='" + hemph["empnum"].ToString().Trim() + "'" +
                //                    ")A " +
                //                    "group by refnum,[YEAR],ttscore,ttmaxscore,ttfactors";

                //string getAppraisalStr = "SELECT "+
                //                            "refnum, "+
                //                            "[YEAR], "+
                //                            "CASE WHEN ISNULL(SUM(ttscore),0)>0 THEN ISNULL(SUM(ttscore),0) ELSE mtotalscore END   as [Total Score], "+
                //                            "ISNULL(SUM(ttmaxscore),0) as [Total Max Score], "+
                //                            "ISNULL(SUM(ttfactors),0) as [Total Factor],   "+
                //                            "CASE WHEN ttscore>0 and ttfactors>0 then ttscore/ttfactors ELSE CONVERT(decimal(16,2),0) END as [Total Avg Factor] "+
                //                             "FROM  "+
                //                             "(  "+
                //                                "select sh.refnum,YEAR(sh.trandate) as [Year], SUM(ISNULL(s1.score,0)) as ttscore, sh.mtotalscore, SUM(ISNULL(s1.maxscore,0)) as ttmaxscore, count(*) as ttfactors  from sadjh sh "+
                //                                "left join SADJ1 s1 on sh.refnum=s1.refnum where sh.flag IN ('APPR','APPH') and sh.[status]='P' and ISNULL(sh.isapproved,0)=1 and sh.empnum='" + hemph["empnum"].ToString().Trim() + "' GROUP BY sh.refnum,YEAR(sh.trandate),SH.mtotalscore " +
                //                            ")A group by refnum,[YEAR],ttscore,mtotalscore,ttmaxscore,ttfactors ";
                ...
                string getAppraisalStr = "SELECT "+
	                                        ...
	                                        "ISNULL(SUM(ttmaxscore),0) as [Total Max Score],  "+
	                                        "ISNULL(SUM(ttfactors),0) as [Total Factor],    "+
	                                        "CASE WHEN ttscore>0 and ttfactors>0 then  CONVERT(decimal(16,2),ttscore/ttfactors) ELSE CONVERT(decimal(16,2),0) END as [Total Avg Factor]  "+
	                                        "FROM   "+
	                                        "(   "+
		                                        "select  "+
			                                        "sh.refnum, "+
			                                        "YEAR(sh.trandate) as [Year],  "+
                                                    "MONTH(sh.trandate) as [Month],  " +
			                                        "SUM(ISNULL(s1.score,0)) as ttscore,  "+
			                                        "sh.mtotalscore,  "+
			                                        "SUM(ISNULL(CONVERT(decimal(16,2),s1.maxscore),0)) as ttmaxscore,  "+
			                                        "CONVERT(decimal(16,2),count(*)) as ttfactors,   "+
                                                    "sh.trandate "+
			                                        "from sadjh sh left join SADJ1 s1 on sh.refnum=s1.refnum  "+
			                                        "where sh.flag IN ('APPR','APPH') and sh.[status]='P'  "+
                                                    "and ISNULL(sh.isapproved,0)=1 and sh.empnum='" + hemph["empnum"].ToString().Trim() + "'  " +
                                                    "GROUP BY sh.refnum,YEAR(sh.trandate),MONTH(sh.trandate),SH.mtotalscore,sh.trandate  " +
                                            ")A group by refnum,[YEAR],[MONTH],trandate,ttscore,mtotalscore,ttmaxscore,ttfactors order by trandate DESC  ";

                this.dbaccess.ReadSQL("dtAppraisalHistory", getAppraisalStr);
                if (this.dbaccess.DataSet.Tables["dtAppraisalHistory"].Rows.Count > 0)
                {

                    dg_appraise.DataSource = this.dbaccess.DataSet.Tables["dtAppraisalHistory"];

                }
            }
            dg_appraise.CaptionText = "Appraisal";
        }
        ...
        private void GetLeavetHistory()
        {
            ...
            if (!BizFunctions.IsEmpty(hemph["empnum"]))
            {
                ...
                string str1 = "SELECT Lv.refnum as Refnum, Lv.LeaveYear as [Year], Lv.leavefrom as [From] ,Lv.leaveto as [To],Lm.lvmnum as [Desc],Lv.totaldays as Days,Lv.apprdby as ApprovedBy " +
                                ...
                                "where empnum='" + hemph["empnum"].ToString() + "' and lv.[status]='P' AND isapproved=1 AND Lv.totaldays>0" +
        ...
        private void GetTrainingtHistory()
        {
            ...
            if (!BizFunctions.IsEmpty(hemph["nric"]))
            {
                ...
                string GetEmpHistoryStr = "Select * from "+
                                            ...
                                            "from trn1 t1 left join trnh th on t1.refnum=th.refnum where t1.empnum='" + hemph["empnum"].ToString() + "' and th.[status]<>'V' and th.[flag]='TRN'  " +
                                            ")A "+
                                            "UNION "+
                                            "Select * from "+
                                            "( "+
        ...
        private void SetLatestNationality()
        {
            DataRow hemph = this.dbaccess.DataSet.Tables["HEMPH"].Rows[0];
            DataTable hemp2 = this.dbaccess.DataSet.Tables["HEMP2"];

            if (hemp2.Rows.Count > 0)
            {
                foreach (DataRow dr2 in hemp2.Rows)
                {
                    if (dr2.RowState != DataRowState.Deleted)
                    {
                        if (BizFunctions.IsEmpty(dr2["islatest"]))
                        {
                            dr2["islatest"] = 0;
                        }

                        if ((bool)dr2["islatest"])
                        {
                            hemph["nationality"] = dr2["nationality"];

                            if (!BizFunctions.IsEmpty(dr2["effectivedate"]))
                            {
                                hemph["datePR"] = dr2["effectivedate"];
                            }
                        }
        ...
        private void SetIsEmergencyContact()
        {
            DataRow hemph = this.dbaccess.DataSet.Tables["HEMPH"].Rows[0];
            DataTable famr = this.dbaccess.DataSet.Tables["FAMR"];
            ...
            if (famr.Rows.Count > 0)
            {
                foreach (DataRow dr2 in famr.Rows)
                {
                    if (dr2.RowState != DataRowState.Deleted)
                    {
                        if (BizFunctions.IsEmpty(dr2["isemergency"]))
                        {
                            dr2["isemergency"] = 0;
                        }

                        if ((bool)dr2["isemergency"])
                        {

                            hemph["emgContact"] = dr2["contact"];
                            hemph["emgName"] = dr2["name"];
                            hemph["emgRelationship"] = dr2["relationship"];
                            //hemph["nationality"] = dr2["nationality"];
                        }
                    }
                }
        ...
        void eduDownColumnButton_Click(object sender, EventArgs e)
        {
            DataTable pfmedu = this.dbaccess.DataSet.Tables["pfmedu"];

            if (pfmedu.Rows.Count > 0)
            {
                if (!BizFunctions.IsEmpty(pfmedu.Rows[dg_education.CurrentCell.RowNumber]["physicalserverlocation"]))
                {
                    Process.Start(pfmedu.Rows[dg_education.CurrentCell.RowNumber]["physicalserverlocation"].ToString());
                }
                else
                {
                    MessageBox.Show("This Document was Found", "No Document", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
        }

        void eduUpColumnButton_Click(object sender, EventArgs e)
        {
            ...
            if (!BizFunctions.IsEmpty(pfmedu.Rows[dg_education.CurrentCell.RowNumber]["physicalserverlocation"]))
            {
                ...
                {
                    edufilename = openFileDialog.FileName;
                    ...
                    if (pfmedu.Rows.Count > 0)
                    {
                        ...
                        if (count > 0)
                        {
                            ...
                            string CompleteLocation = RepositoryLocation + "\\" + hemph["empnum"].ToString().Trim() + "\\";
                            ...
                            try
                            {
                                ...
                                pfmedu.Rows[dg_education.CurrentCell.RowNumber]["physicalserverlocation"] = destifilePath.Trim();
                            }
                            catch (Exception ex)
                            {
        ...
        void permitdocColumnDownButton_Click(object sender, EventArgs e)
        {
            DataTable plr = this.dbaccess.DataSet.Tables["plr"];

            if (plr.Rows.Count > 0)
            {
                if (!BizFunctions.IsEmpty(plr.Rows[dg_permits.CurrentCell.RowNumber]["physicalserverlocation"]))
                {
                    Process.Start(plr.Rows[dg_permits.CurrentCell.RowNumber]["physicalserverlocation"].ToString());
                }
                else
                {
                    MessageBox.Show("This Document was Found", "No Document", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        void permitdocColumnUpButton_Click(object sender, EventArgs e)
        {
            DataRow hemph = this.dbaccess.DataSet.Tables["hemph"].Rows[0];
            DataTable plr = this.dbaccess.DataSet.Tables["plr"];
            string RepositoryLocation = System.Configuration.ConfigurationManager.AppSettings.Get("BizERPDocsRepository");
            ...
            if (!BizFunctions.IsEmpty(plr.Rows[dg_permits.CurrentCell.RowNumber]["physicalserverlocation"]))
            {
                if (MessageBox.Show("There is an existing file, do you want to overwrite it?", "Notification", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    ...
                    permitfilename = openFileDialog.FileName;
                    ...
                    if (plr.Rows.Count > 0)
                    {
                        ...
                        if (count > 0)
                        {
                            ...
                            try
                            {
                                ...
                                plr.Rows[dg_permits.CurrentCell.RowNumber]["physicalserverlocation"] = destifilePath.Trim();
                            }
                            catch (Exception ex)
                            {
                                MessageBox.Show("Could not copy files to temp folder.", "File Error");
        ...
        void docColumnPrevButton_Click(object sender, EventArgs e)
        {
            ...
            if (pffa.Rows.Count > 0)
            {
                if (!BizFunctions.IsEmpty(pffa.Rows[dg_archive.CurrentCell.RowNumber]["physicalserverlocation"]))
                {
                    Process.Start(pffa.Rows[dg_archive.CurrentCell.RowNumber]["physicalserverlocation"].ToString());
                }
                else
                {
                    MessageBox.Show("This Document was Found", "No Document", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        void docColumnUpButton_Click(object sender, EventArgs e)
        {
            DataRow hemph = this.dbaccess.DataSet.Tables["hemph"].Rows[0];
            DataTable pffa = this.dbaccess.DataSet.Tables["pffa"];
            string RepositoryLocation = System.Configuration.ConfigurationManager.AppSettings.Get("BizERPDocsRepository");
            ...
            if (!BizFunctions.IsEmpty(pffa.Rows[dg_archive.CurrentCell.RowNumber]["physicalserverlocation"]))
            {
                if (MessageBox.Show("There is an existing file, do you want to overwrite it?", "Notification", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    ...
                    archivefilename = openFileDialog.FileName;
                    ...
                    if (pffa.Rows.Count > 0)
                    {
                        ...
                        if (count > 0)
                        {
                            ...
                            try
                            {
                                ...
                                pffa.Rows[dg_archive.CurrentCell.RowNumber]["physicalserverlocation"] = destifilePath.Trim();
                            }
                            catch (Exception ex)
                            {
                                MessageBox.Show("Could not copy files to temp folder.", "File Error");
        ...
        private void getSitenumt()
        {
            DataRow hemph = this.dbaccess.DataSet.Tables["hemph"].Rows[0];

            if (!BizFunctions.IsEmpty(hemph["sitenum"]))
            {
                string get1 = "Select sitenumt from sitmt where [status]<>'V' and sitenum='" + hemph["sitenum"].ToString() + "' ";

                this.dbaccess.ReadSQL("TmpSitmtAll", get1);

                DataTable TmpSitmtAll = this.dbaccess.DataSet.Tables["TmpSitmtAll"];

                if (TmpSitmtAll.Rows.Count > 0)
                {
                    hemph["sitenumt"] = TmpSitmtAll.Rows[0]["sitenumt"].ToString();
                }
