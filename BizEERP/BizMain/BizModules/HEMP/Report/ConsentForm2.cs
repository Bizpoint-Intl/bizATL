...
namespace ATL.BizModules.HEMP.Report {
    ...
    public class ConsentForm2 : ReportClass {
    ...
    public class CachedConsentForm2 : Component, ICachedReport {
        
        public CachedConsentForm2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ConsentForm2 rpt = new ConsentForm2();
            rpt.Site = this.Site;
            return rpt;
        }
