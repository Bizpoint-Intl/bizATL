...
namespace ATL.BizModules.HEMP.Report {
    ...
    public class ApplicationForm1 : ReportClass {
    ...
    public class CachedApplicationForm1 : Component, ICachedReport {
        
        public CachedApplicationForm1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ApplicationForm1 rpt = new ApplicationForm1();
            rpt.Site = this.Site;
            return rpt;
        }
