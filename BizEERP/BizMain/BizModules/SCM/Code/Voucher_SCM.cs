...
namespace PicGuards.SCM
{
    public class Voucher_SCM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_SCM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_SCM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
