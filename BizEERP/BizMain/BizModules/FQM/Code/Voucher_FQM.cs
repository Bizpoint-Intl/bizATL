...
namespace ATL.FQM
{
    public class Voucher_FQM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_FQM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_FQM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
