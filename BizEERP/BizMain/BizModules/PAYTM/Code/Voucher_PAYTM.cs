...
namespace ATL.PAYTM
{
    public class Voucher_PAYTM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_PAYTM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_PAYTM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
