...
namespace ATL.SADJM
{
    public class Voucher_SADJM : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        public Voucher_SADJM(string moduleName, Hashtable voucherBaseHelpers)

            : base("VoucherGridInfo_SADJM.xml", moduleName, voucherBaseHelpers)
        {
        }
        #endregion Construct
