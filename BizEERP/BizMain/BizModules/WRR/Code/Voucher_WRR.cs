...
namespace ATL.WRR
{
    public class Voucher_WRR : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        protected override void Document_Form_OnLoad(object sender, DocumentEventArgs e)
        {
            ...
            //Jason(17/09/2014) : ATL doesn't need the Night and Concierge
        ...
        protected override void Document_Save_Handle(object sender, DocumentHandleEventArgs e)
        {
            ...
            if (!voidClicked || !reOpen)
            {
                ...
                //Jason: Commented temporarilily 06/11/2014
                    ...
                    if (!BizFunctions.IsEmpty(wrr["adhocrefnum"]))
                    {
                        ...
                        if (Convert.ToDateTime(wrr["commencedate"]).ToShortDateString() == Convert.ToDateTime(e.F2CurrentRow["adhocFrom"]).ToShortDateString() && Convert.ToDateTime(wrr["enddate"]).ToShortDateString() == Convert.ToDateTime(e.F2CurrentRow["adhocTo"]).ToShortDateString())
                        {
                            ...
                            if (!BizFunctions.IsEmpty(wrr["adhocrefnum"].ToString().Trim()) || wrr["adhocrefnum"].ToString().Trim() != string.Empty)
                            {
                                ...
                                {
                                    MessageBox.Show("Contract No. Doesn't Exist!", "ATL", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                    return;
                                }
                        ...
                        {
                            MessageBox.Show("Can't Add Schedule which is different from the Header Schedule!", "ATL", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                ...
                case "wrr_empnum":
                    {
                        ...
                        e.CurrentRow["sitenumt"] = System.DBNull.Value;
                        e.CurrentRow["docunum"] = System.DBNull.Value;
        ...
        private void GetSitmByContract()
        {
            DataRow wrr = this.dbaccess.DataSet.Tables["wrr"].Rows[0];

            wrr["sitenum"] = System.DBNull.Value;
            wrr["sectorcode"] = System.DBNull.Value;
            wrr["addr1"] = System.DBNull.Value;
            wrr["addr2"] = System.DBNull.Value;
            wrr["addr3"] = System.DBNull.Value;
            wrr["postalcode"] = System.DBNull.Value;
            wrr["tel1"] = System.DBNull.Value;
            wrr["fax"] = System.DBNull.Value;
            wrr["rep1"] = System.DBNull.Value;
            wrr["rep1tel"] = System.DBNull.Value;
            wrr["rep2"] = System.DBNull.Value;
            wrr["rep2tel"] = System.DBNull.Value;
            wrr["sectorcode"] = System.DBNull.Value;
            wrr["event"] = System.DBNull.Value;
            wrr["schedule"] = System.DBNull.Value;
            wrr["officerqty"] = System.DBNull.Value;
            wrr["contractdate"] = System.DBNull.Value;
            wrr["commencedate"] = System.DBNull.Value;
            wrr["enddate"] = System.DBNull.Value;
            wrr["issuedby"] = System.DBNull.Value;
        ...
        private void GetSitm1ByOE()
        {
            DataRow wrr = this.dbaccess.DataSet.Tables["wrr"].Rows[0];
            DataTable wrr1 = this.dbaccess.DataSet.Tables["wrr1"];


            string GetSitm1SQL = "Select s8.sitenumt ,St.sitenum,s8.empnum,s8.empname,s8.matnum,st.docunum, " +
                              "s8.xday1 as monday, " +
                              "s8.xday2 as tuesday, " +
                              "s8.xday3 as wednesday, " +
                              "s8.xday4 as thursday, " +
                              "s8.xday5 as friday, " +
                              "s8.xday6 as saturday, " +
                              "s8.xday7 as sunday " +
                              "from sitmt8 s8 left join sitmt st on s8.sitenumt=st.sitenumt where st.docunum in (SELECT refnum as docunum from ctrh where empnum='" + wrr["empnum"].ToString() + "')  and st.[status]<>'V' ";
        ...
        private void GetSitm1ByContract()
        {
            DataRow wrr = this.dbaccess.DataSet.Tables["wrr"].Rows[0];
            DataTable wrr1 = this.dbaccess.DataSet.Tables["wrr1"];


            string GetSitm1SQL = "Select s8.sitenumt ,St.sitenum,s8.empnum,s8.empname,s8.matnum, " +
                              "s8.xday1 as monday, " +
                              "s8.xday2 as tuesday, " +
                              "s8.xday3 as wednesday, " +
                              "s8.xday4 as thursday, " +
                              ...
                              "s8.xday6 as saturday, " +
                              "s8.xday7 as sunday " +
                              "from sitmt8 s8 left join sitmt st on s8.sitenumt=st.sitenumt where st.docunum='" + wrr["docunum"].ToString() + "' and st.[status]<>'V' ";
        ...
        private void GetSitm1All()
        {
            ...
            string GetSitm1SQL = "Select sitenumt ,empnum,empname,matnum,ctrnum,sitenum, " +
                              ...
                              "xday6 as saturday, " +
                              "xday7 as sunday " +
                              "from sitmt8 where [status]<>'V' and sitenumt<>'ALLOUTLETS' and empnum is not null ORDER BY empnum";
        ...
        private void GetSitm4ByContract()
        {
            DataRow wrr = this.dbaccess.DataSet.Tables["wrr"].Rows[0];
            DataTable wrr4 = this.dbaccess.DataSet.Tables["wrr4"];


            string GetSitm4SQL = "select s4.empnum, st.sitenum, s4.empname, s4.matnum from sitmt4 s4 left join sitmt st on s4.sitenumt=st.sitenumt where st.docunum ='" + wrr["docunum"].ToString() + "' and st.[status]<>'V' ";
        ...
        private void GetSitm4ByOE()
        {
            DataRow wrr = this.dbaccess.DataSet.Tables["wrr"].Rows[0];
            DataTable wrr4 = this.dbaccess.DataSet.Tables["wrr4"];


            string GetSitm4SQL = "select s4.empnum, st.sitenum,st.docunum, s4.empname, s4.matnum from sitmt4 s4 left join sitmt st on s4.sitenumt=st.sitenumt where st.docunum in (SELECT refnum as docunum from ctrh where empnum='"+wrr["empnum"].ToString()+"') and st.[status]<>'V' ";
        ...
        private string ShiftTimein(string Day, string shiftcode)
        {
            ...
            //Jason: 24/10/2014 - Just need the shift timein/timeout.
            //string get = "select [timein] from shm2 where [day]='" + Day + "' and shiftcode='" + shiftcode + "'";
            string get = "select [timein] from shm where shiftcode='" + shiftcode + "'";
        ...
        private string ShiftTimeOut(string Day, string shiftcode)
        {
            ...
            string get = "select [timeout] from shm where shiftcode='" + shiftcode + "'";
