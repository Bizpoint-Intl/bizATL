...
using NodaTime;
using PicoGuards.SortTable;
using PicoGuards.Schedule;

#endregion

namespace PicoGuards.WRR
{
    public class Voucher_WRR : BizRAD.BizApplication.VoucherBaseHelper
    {
        ...
        bool columnChanged, isSummarized;
        ...
        protected TextBox wrr1Total_monday, wrr1Total_tuesday, wrr1Total_wednesday, wrr1Total_thursday, wrr1Total_friday,
        ...
        private void btn_Voucher_Reports_Click(object sender, EventArgs e)
        {
            ...
            if (wrr["status"].ToString().Trim() == Common.DEFAULT_DOCUMENT_STATUSO || wrr["status"].ToString().Trim() == Common.DEFAULT_DOCUMENT_STATUSP)
            {
                ...
                ReportLists.Reports ReportForm = new PicoGuards.ReportLists.Reports(false, "WRR", "WRR", wrr["refnum"].ToString());
        ...
        private void ClearDays()
        {
            ...
            //string[] weekDaysToDelete = new string[7];
        ...
        #region Detail TextBoxes Keydown and Click Events

        //protected void wrr1_dayshiftcode_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        //{
        //    if (e.KeyCode == Keys.F2)
        //    {
        //        DataTable wrr1 = this.dbaccess.DataSet.Tables["wrr1"];
        //        wrr1_dayshiftcode.Text = BizLogicTools.Tools.GetF2KeyDown(sender, e, null, null, "vSHLV", "shiftcode");
        //        foreach (DataRow dr1 in wrr1.Rows)
        //        {
        //            if (dr1.RowState != DataRowState.Deleted)
        //            {
        //                dr1["shiftcode"] = wrr1_dayshiftcode.Text.ToString().Trim();
        //                dr1["monday"] = wrr1_dayshiftcode.Text.ToString().Trim();
        //                dr1["tuesday"] = wrr1_dayshiftcode.Text.ToString().Trim();
        //                dr1["wednesday"] = wrr1_dayshiftcode.Text.ToString().Trim();
        //                dr1["thursday"] = wrr1_dayshiftcode.Text.ToString().Trim();
        //                dr1["friday"] = wrr1_dayshiftcode.Text.ToString().Trim();
        //                dr1["saturday"] = wrr1_dayshiftcode.Text.ToString().Trim();
        //                dr1["sunday"] = wrr1_dayshiftcode.Text.ToString().Trim();
        //            }
        //        }
        //    }
        //}

        //protected void wrr1_dayshiftcode_Click(object sender, System.EventArgs e)
        //{
        //    DataTable wrr1 = this.dbaccess.DataSet.Tables["wrr1"];
        //    wrr1_dayshiftcode.Text = BizLogicTools.Tools.GetF2Clicked(sender, e, "vSHLV", "shiftcode");
        //     foreach (DataRow dr1 in wrr1.Rows)
        //    {
        //        if (dr1.RowState != DataRowState.Deleted)
        //        {
        ...
        //protected void wrr2_nightshiftcode_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        //{
        //    if (e.KeyCode == Keys.F2)
        //    {
        //        DataTable wrr2 = this.dbaccess.DataSet.Tables["wrr2"];
        //        wrr2_nightshiftcode.Text = BizLogicTools.Tools.GetF2KeyDown(sender, e, null, null, "vSHLV", "shiftcode");
        //        foreach (DataRow dr1 in wrr2.Rows)
        //        {
        //            if (dr1.RowState != DataRowState.Deleted)
        //            {
        //                dr1["shiftcode"] = wrr2_nightshiftcode.Text.ToString().Trim();
        //                dr1["monday"] = wrr2_nightshiftcode.ToString().Trim();
        //                dr1["tuesday"] = wrr2_nightshiftcode.Text.ToString().Trim();
        //                dr1["wednesday"] = wrr2_nightshiftcode.Text.ToString().Trim();
        //                dr1["thursday"] = wrr2_nightshiftcode.Text.ToString().Trim();
        //                dr1["friday"] = wrr2_nightshiftcode.Text.ToString().Trim();
        //                dr1["saturday"] = wrr2_nightshiftcode.Text.ToString().Trim();
        //                dr1["sunday"] = wrr2_nightshiftcode.Text.ToString().Trim();
        //            }
        //        }
        //    }
        ...
        //protected void wrr2_nightshiftcode_Click(object sender, System.EventArgs e)
        //{
        //    DataTable wrr2 = this.dbaccess.DataSet.Tables["wrr2"];
        //    wrr2_nightshiftcode.Text = BizLogicTools.Tools.GetF2Clicked(sender, e, "vSHLV", "shiftcode");
        //     foreach (DataRow dr1 in wrr2.Rows)
        //    {
        //        if (dr1.RowState != DataRowState.Deleted)
        //        {
        //            dr1["shiftcode"] = wrr2_nightshiftcode.Text.ToString().Trim();
        //            dr1["monday"] = wrr2_nightshiftcode.Text.ToString().Trim();
        //            dr1["tuesday"] = wrr2_nightshiftcode.Text.ToString().Trim();
        //            dr1["wednesday"] = wrr2_nightshiftcode.Text.ToString().Trim();
        //            dr1["thursday"] = wrr2_nightshiftcode.Text.ToString().Trim();
        //            dr1["friday"] = wrr2_nightshiftcode.Text.ToString().Trim();
        ...
        //protected void wrr3_concierge_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        //{
        //    if (e.KeyCode == Keys.F2)
        //    {
        //        DataTable wrr3 = this.dbaccess.DataSet.Tables["wrr3"];
        //        wrr3_concierge.Text = BizLogicTools.Tools.GetF2KeyDown(sender, e, null, null, "vSHLV", "shiftcode");
        //        foreach (DataRow dr1 in wrr3.Rows)
        //        {
        //            if (dr1.RowState != DataRowState.Deleted)
        //            {
        //                dr1["shiftcode"] = wrr3_concierge.Text.ToString().Trim();
        //                dr1["monday"] = wrr3_concierge.Text.ToString().Trim();
        //                dr1["tuesday"] = wrr3_concierge.Text.ToString().Trim();
        //                dr1["wednesday"] = wrr3_concierge.Text.ToString().Trim();
        //                dr1["thursday"] = wrr3_concierge.Text.ToString().Trim();
        //                dr1["friday"] = wrr3_concierge.Text.ToString().Trim();
        //                dr1["saturday"] = wrr3_concierge.Text.ToString().Trim();
        //                dr1["sunday"] = wrr3_concierge.Text.ToString().Trim();
        //            }
        //        }
        //    }
        ...
        //protected void wrr3_concierge_Click(object sender, System.EventArgs e)
        //{
        //    DataTable wrr3 = this.dbaccess.DataSet.Tables["wrr3"];
        //    wrr3_concierge.Text = BizLogicTools.Tools.GetF2Clicked(sender, e, "vSHLV", "shiftcode");
        //     foreach (DataRow dr1 in wrr3.Rows)
        //    {
        //        if (dr1.RowState != DataRowState.Deleted)
        //        {
        ...
        protected override void Document_Save_Handle(object sender, DocumentHandleEventArgs e)
        {
            ...
            if (e.Handle && !isDuplicateInShift("wrr1", "wrr2", "wrr3", "empnum"))
            {
                e.Handle = false;
            }

            if (e.Handle && !isDuplicateInShift("wrr2", "wrr1", "wrr3", "empnum"))
            {
                e.Handle = false;
            }

            if (e.Handle && !isDuplicateInShift("wrr3", "wrr2", "wrr1", "empnum"))
            {
                e.Handle = false;
            }
                ...
                case "monday":
                    {
                        ...
                        if (e.TableName == "wrr1")
                        {
                            //e.DefaultCondition = "shiftcode='" + wrr1_dayshiftcode.Text.ToString().Trim() + "' OR isWorkShift=0";                     
                        }
                        if (e.TableName == "wrr2")
                        {
                            //e.DefaultCondition = "shiftcode='" + wrr2_nightshiftcode.Text.ToString().Trim() + "' OR isWorkShift=0";
                        }
                        if (e.TableName == "wrr3")
                        {
                            //e.DefaultCondition = "shiftcode='" + wrr3_concierge.Text.ToString().Trim() + "' OR isWorkShift=0";
                        }
                        if (e.TableName == "wrr4")
                        {
                            //e.DefaultCondition = "shiftcode='" + wrr1_dayshiftcode.Text.ToString().Trim() + "' OR shiftcode='" + wrr2_nightshiftcode.Text.ToString().Trim() +"' " +
                            //                     "OR shiftcode='" + wrr3_concierge.Text.ToString().Trim() + "' OR isWorkShift=0";
                        }
                ...
                case "empnum":
                    {
                        ...
                        //e.Row["shiftcode"] = wrr1_dayshiftcode.Text.ToString().Trim();
                ...
                case "monday":
                    {
                        ...
                        //{
                        //    if (isAllowedDay(e.Column.ToString()))
                        //    {
                        //e.Row["shiftcode"] = wrr1_dayshiftcode.Text.ToString().Trim();
                        //    }
                        //    else
                        ...
                        //                if (dr1.RowState != DataRowState.Deleted)
                        //                {
                        //                    if (dr1[e.Column.ToString()].ToString() != string.Empty)
                        //                    {
                        //                        dr1[e.Column.ToString()] = string.Empty;                                              
                        //                    }
                        //                }
                        //            }
                ...
                case "empnum":
                    {
                        ...
                        //    if (isAllowedDay(e.Column.ToString()))
                        //    {
                        //e.Row["shiftcode"] = wrr2_nightshiftcode.Text.ToString().Trim();
                        //    }
                        //    else
                        //    {
                ...
                case "empnum":
                    {
                        ...
                        //e.Row["shiftcode"] = wrr3_concierge.Text.ToString().Trim();
                        if (!BizFunctions.IsEmpty(e.Row["empnum"]))
                        {
                            e.Row["empname"] = GetEmpname(e.Row["empnum"].ToString());
                            e.Row["matnum"] = GetMatnum(e.Row["empnum"].ToString());
        ...
        private void GetSitm()
        {
            ...
            string GetSitmSQL = "Select sitenumi, sectorcode,addr1,addr2,addr3,postalcode,tel1,fax, rep1, rep1tel,rep2, rep2tel, " +
            ...
            if (TmpSitm.Rows.Count > 0)
            {
                foreach (DataRow dr1 in TmpSitm.Select())
                {
                    if (dr1.RowState != DataRowState.Deleted)
                    {
                        wrr["sitenumi"] = dr1["sitenumi"].ToString();
                        ...
                        wrr["officerqty"] = dr1["officerqty"].ToString();
        ...
        private void updateATMR()
        {
            ...
            string FinalSchedule = "Select FW.REFNUM,FW.TB,FW.EMPNUM,FW.NRIC,FW.SHIFTCODE,FW.[DAY],FW.TIMEIN,FW.[TIMEOUT],FB.[DATE] FROM FinalAMTR FW " +
        ...
        {
            string sql1 = "";
            sql1 = "SELECT M1.refnum,M1.TB,M1.EMPNUM,M1.NRIC, M1.shiftcode, [day], vS.TIMEIN,vS.[TIMEOUT] " +
                "FROM " +
                "( " +
                    "Select unP.refnum,TB,unP.empnum,unP.nric,shiftcode,[day] from " +
                    "( " +
                        "select refnum,empnum,nric,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday,'wrr1' as TB from wrr1 where refnum='" + refnum + "'" +
                    ") as p " +
                    "UNPIVOT " +
                    "( " +
                    ...
                    "Select unP.refnum,TB,unP.empnum,unP.nric,shiftcode,[day]  from " +
                    "( " +
                        "select refnum,empnum,nric,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday,'wrr2' as TB  from wrr2 where refnum='" + refnum + "'" +
                    ") as p " +
                    "UNPIVOT " +
                    "( " +
                        "shiftcode for [day] in (MONDAY,TUESDAY,WEDNESDAY,THURSDAY,FRIDAY,SATURDAY,SUNDAY) " +
                    ...
                    "Select unP.refnum,TB,unP.empnum,unP.nric,shiftcode,[day]  from " +
                    "( " +
                       "select refnum,empnum,nric,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday,'wrr3' as TB  from wrr3 where refnum='" + refnum + "'" +
                    ") as p " +
                    "UNPIVOT " +
                    "( " +
                        "shiftcode for [day] in (MONDAY,TUESDAY,WEDNESDAY,THURSDAY,FRIDAY,SATURDAY,SUNDAY) " +
                    ...
                    "Select unP.refnum,TB,unP.empnum,unP.nric,shiftcode,[day]  from " +
                    "( " +
                        "select refnum,empnum,nric,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday,'wrr4' as TB  from wrr4 where refnum='" + refnum + "'" +
                    ") as p " +
                    "UNPIVOT " +
                    "( " +
                        "shiftcode for [day] in (MONDAY,TUESDAY,WEDNESDAY,THURSDAY,FRIDAY,SATURDAY,SUNDAY) " +
                    ")unP " +
                ")M1 " +
            "LEFT JOIN vSHLV vS on M1.shiftcode=vS.SHIFTCODE";
        ...
        {
            wrr1Total_monday.Text = Convert.ToString(EmpTotalofDay("monday", "wrr1") - EmpTotalBufferofDay("monday","wrr1","isoptional"));
            wrr1Total_tuesday.Text = Convert.ToString(EmpTotalofDay("tuesday", "wrr1") - EmpTotalBufferofDay("tuesday", "wrr1", "isoptional"));
            wrr1Total_wednesday.Text = Convert.ToString(EmpTotalofDay("wednesday", "wrr1") - EmpTotalBufferofDay("wednesday", "wrr1", "isoptional"));
            wrr1Total_thursday.Text = Convert.ToString(EmpTotalofDay("thursday", "wrr1") - EmpTotalBufferofDay("thursday", "wrr1", "isoptional"));
            wrr1Total_friday.Text = Convert.ToString(EmpTotalofDay("friday", "wrr1") - EmpTotalBufferofDay("friday", "wrr1", "isoptional"));
            wrr1Total_saturday.Text = Convert.ToString(EmpTotalofDay("saturday", "wrr1") - EmpTotalBufferofDay("saturday", "wrr1", "isoptional"));
            wrr1Total_sunday.Text = Convert.ToString(EmpTotalofDay("sunday", "wrr1") - EmpTotalBufferofDay("sunday", "wrr1", "isoptional"));
        }

        private void Getwrr2FooterTotals()
        {
            wrr2Total_monday.Text = Convert.ToString(EmpTotalofDay("monday", "wrr2") - EmpTotalBufferofDay("monday", "wrr2", "isoptional"));
            wrr2Total_tuesday.Text = Convert.ToString(EmpTotalofDay("tuesday", "wrr2") - EmpTotalBufferofDay("monday", "wrr2", "isoptional"));
            wrr2Total_wednesday.Text = Convert.ToString(EmpTotalofDay("wednesday", "wrr2") - EmpTotalBufferofDay("monday", "wrr2", "isoptional"));
            wrr2Total_thursday.Text = Convert.ToString(EmpTotalofDay("thursday", "wrr2") - EmpTotalBufferofDay("monday", "wrr2", "isoptional"));
            wrr2Total_friday.Text = Convert.ToString(EmpTotalofDay("friday", "wrr2") - EmpTotalBufferofDay("monday", "wrr2", "isoptional"));
            wrr2Total_saturday.Text = Convert.ToString(EmpTotalofDay("saturday", "wrr2") - EmpTotalBufferofDay("monday", "wrr2", "isoptional"));
            wrr2Total_sunday.Text = Convert.ToString(EmpTotalofDay("sunday", "wrr2") - EmpTotalBufferofDay("monday", "wrr2", "isoptional"));
        }

        private void Getwrr3FooterTotals()
        {
            wrr3Total_monday.Text = Convert.ToString(EmpTotalofDay("monday", "wrr3") - EmpTotalBufferofDay("monday", "wrr3", "isoptional"));
            wrr3Total_tuesday.Text = Convert.ToString(EmpTotalofDay("tuesday", "wrr3") - EmpTotalBufferofDay("monday", "wrr3", "isoptional"));
            wrr3Total_wednesday.Text = Convert.ToString(EmpTotalofDay("wednesday", "wrr3") - EmpTotalBufferofDay("monday", "wrr3", "isoptional"));
            wrr3Total_thursday.Text = Convert.ToString(EmpTotalofDay("thursday", "wrr3") - EmpTotalBufferofDay("monday", "wrr3", "isoptional"));
            wrr3Total_friday.Text = Convert.ToString(EmpTotalofDay("friday", "wrr3") - EmpTotalBufferofDay("monday", "wrr3", "isoptional"));
            wrr3Total_saturday.Text = Convert.ToString(EmpTotalofDay("saturday", "wrr3") - EmpTotalBufferofDay("monday", "wrr3", "isoptional"));
            wrr3Total_sunday.Text = Convert.ToString(EmpTotalofDay("sunday", "wrr3") - EmpTotalBufferofDay("monday", "wrr3", "isoptional"));
        }
        ...
        private bool isDuplicateInShift(string table1, string table2, string table3, string column)
        {
            ...
            for (Int32 r0 = 0; r0 < dataTable1.Rows.Count; r0++)
            {
                ...
                //important
                //if (rowsEqual && !isExistinOtherActiveSchedules(dataTable1.Rows[r0][column].ToString().Trim()))
                //{
                //    rowsEqual = false;
                //}
        ...
        {
            DataRow wrr = this.dbaccess.DataSet.Tables["wrr"].Rows[0];
            string getWeeklySchedule = "select * from ATMR where [date]>='" +  BizFunctions.GetSafeDateString(Convert.ToDateTime(wrr["commencedate"])) + "' and [date]<='" + BizFunctions.GetSafeDateString(Convert.ToDateTime(wrr["commencedate"])) + "' and refnum<>'" + wrr["refnum"] + "' and [status]<>'V'";
                    ...
                    if (dr1.RowState != DataRowState.Deleted)
                    {
                        foreach (DataRow dr2 in CurrentSchedule.Rows)
                        {
                            if (dr2.RowState != DataRowState.Deleted)
                            {
                                ...
                                if (dr1["empnum"].ToString() == dr2["empnum"].ToString() && dr1["shiftcode"].ToString() == dr2["shiftcode"].ToString() && BizFunctions.GetSafeDateString(Convert.ToDateTime(dr1["Date"])) == BizFunctions.GetSafeDateString(Convert.ToDateTime(dr2["Date"])))
                                {
